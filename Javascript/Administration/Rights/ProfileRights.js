...
/// Description   : This is the Form  For Master Profile Rights
/// </summary>
/// 
...
{
   var ATS = false;
   var lbl_Errors = document.getElementById('WucProfileRights1_lbl_Errors');
   var ddl_Hierarchy = document.getElementById('WucProfileRights1_ddl_Hierarchy');
   var ddl_Profile=document.getElementById('WucProfileRights1_ddl_Profile');
   var ddl_MenuSystem=document.getElementById('WucProfileRights1_ddl_MenuSystem');
   var ddl_MenuHead=document.getElementById('WucProfileRights1_ddl_MenuHead');
   var ddl_MenuGroup=document.getElementById('WucProfileRights1_ddl_MenuGroup');  
   
   var objResource = new Resource('WucProfileRights1_hdf_ResourceString');
