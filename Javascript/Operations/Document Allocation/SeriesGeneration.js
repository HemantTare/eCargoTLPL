...
{
var ATS = false;
var lbl_Errors = document.getElementById('WucSeriesGeneration1_lbl_Errors');
var ddl_DocumentType = document.getElementById('WucSeriesGeneration1_ddl_DocumentType');
var txt_StartNo = document.getElementById('WucSeriesGeneration1_txt_StartNo');
var txt_EndNo = document.getElementById('WucSeriesGeneration1_txt_EndNo');
