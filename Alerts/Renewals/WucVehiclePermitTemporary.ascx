<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WucVehiclePermitTemporary.ascx.cs" Inherits="Alerts_Renewals_WucVehiclePermitTemporary" %>
<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
    <tr>
        <td style="width: 1%">
            <asp:Image ID="Img_Left" runat="server" ImageUrl="~/Images/Link.gif" /></td>
        <td style="width: 29%; vertical-align: middle;">
            &nbsp;<asp:Label ID="lbl_Link_Name" runat="server" Text="VEHICLE PERMIT TEMPORARY LIST" CssClass="LABEL" Font-Bold="True"></asp:Label>
...
<tr>
     ...
     <table cellpadding="0" cellspacing="0" style="width: 100%">
        ...
        <tr>
            ...
            <asp:DataGrid ID="dg_VehiclePermitTemporaryGrid" runat="server"  
        ...
        <Columns>
                   ...
                   <asp:TemplateColumn HeaderText="Vehicle_ID"  Visible="False" >
                     ...
                     <asp:TemplateColumn HeaderText="Menu_Item_Id"  Visible="False" >
                        <ItemTemplate>
                            <asp:Label ID="lbl_MenuItemId" runat="server" Text='<%#Eval("MenuItem_ID")%>' ></asp:Label>                
                        </ItemTemplate>
                        <HeaderStyle  cssclass  = "SORTINGLNKBTN"  />
                    </asp:TemplateColumn>
                     ...
                     <asp:TemplateColumn HeaderText="Permit_Type_Id"  Visible="False" >
                        <ItemTemplate>
                            <asp:Label ID="lbl_PermitTypeId" runat="server" Text='<%#Eval("Permit_Type_Id")%>' ></asp:Label>                
                        </ItemTemplate>
                        <HeaderStyle  cssclass  = "SORTINGLNKBTN"  />
                    </asp:TemplateColumn>    
                    ...
                    <asp:TemplateColumn HeaderText="Vehicle No" SortExpression = "Vehicle_No">
                      ...
                      <asp:TemplateColumn HeaderText="State Name" SortExpression = "State Name">
                        <ItemTemplate>
                           <%#DataBinder.Eval(Container.DataItem, "State_Name")%>
                        </ItemTemplate><HeaderStyle  CssClass  = "SORTINGLNKBTN"  />                       
                    </asp:TemplateColumn>
                    
                     <asp:TemplateColumn HeaderText="Permit No" SortExpression = "Permit No">
                        <ItemTemplate>
                           <%#DataBinder.Eval(Container.DataItem, "Permit_No")%>
                        </ItemTemplate><HeaderStyle  CssClass  = "SORTINGLNKBTN"  />                       
                    </asp:TemplateColumn>
                    ...
                    <asp:TemplateColumn HeaderText="Task Completion Method" >
                        <ItemTemplate>
                           <asp:LinkButton ID="lnk_TaskList" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Task_Completion_Method")%>' OnClick="lnk_VehiclePermitTemporary_Click" ></asp:LinkButton>    
                        </ItemTemplate><HeaderStyle  CssClass  = "SORTINGLNKBTN"  />    
                    </asp:TemplateColumn>         
                    </Columns>           
        </asp:DataGrid>                             
