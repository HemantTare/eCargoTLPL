<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WucVehiclePermitTax.ascx.cs" Inherits="Alerts_Renewals_WucVehiclePermitTax" %>
...
<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
    <tr>
        ...
        <td style="width: 29%; vertical-align: middle;">
            &nbsp;<asp:Label ID="lbl_Link_Name" runat="server" Text="VEHICLE PERMIT TAX LIST" CssClass="LABEL" Font-Bold="True"></asp:Label>
...
<tr>
     ...
     <table cellpadding="0" cellspacing="0" style="width: 100%">
        ...
        <tr>
            ...
            <asp:DataGrid ID="dg_VehiclePermitTaxGrid" runat="server"  
        ...
        <Columns>
                   ...
                   <asp:TemplateColumn HeaderText="Vehicle_ID"  Visible="False" >
                     ...
                     <asp:TemplateColumn HeaderText="State_Id"  Visible="False" >
                        <ItemTemplate>
                            <asp:Label ID="lbl_StateId" runat="server" Text='<%#Eval("State_Id")%>' ></asp:Label>                
                        </ItemTemplate>
                        <HeaderStyle  cssclass  = "SORTINGLNKBTN"  />
                    </asp:TemplateColumn>               
                    ...
                    <asp:TemplateColumn HeaderText="Vehicle No" SortExpression = "Vehicle_No">
                      ...
                      <asp:TemplateColumn HeaderText="State Name" SortExpression = "State_Name">
                        <ItemTemplate>
                           <%#DataBinder.Eval(Container.DataItem, "State_Name")%>
                        </ItemTemplate><HeaderStyle  CssClass  = "SORTINGLNKBTN"  />                       
                    </asp:TemplateColumn>
                    
                     <asp:TemplateColumn HeaderText="Permit Type" SortExpression = "Permit Type">
                        <ItemTemplate>
                           <%#DataBinder.Eval(Container.DataItem, "Permit Type")%>
                        </ItemTemplate><HeaderStyle  CssClass  = "SORTINGLNKBTN"  />                       
                    </asp:TemplateColumn>
                    ...
                    <asp:TemplateColumn HeaderText="Task Completion Method" >
                        <ItemTemplate>
                           <asp:LinkButton ID="lnk_TaskList" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Task_Completion_Method")%>' OnClick="lnk_VehiclePermitTax_Click" ></asp:LinkButton>    
                        </ItemTemplate><HeaderStyle  CssClass  = "SORTINGLNKBTN"  />    
                    </asp:TemplateColumn>         
                    </Columns>           
        </asp:DataGrid>                             
