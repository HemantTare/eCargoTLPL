<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WucVehiclePermit.ascx.cs" Inherits="Alerts_Renewals_WucVehiclePermit" %>
<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
    <tr>
        <td style="width: 1%">
            <asp:Image ID="Img_Left" runat="server" ImageUrl="~/Images/Link.gif" /></td>
        <td style="width: 29%; vertical-align: middle;">
            &nbsp;<asp:Label ID="lbl_Link_Name" runat="server" Text="VEHICLE PERMIT LIST" CssClass="LABEL" Font-Bold="True"></asp:Label>
...
<tr>
     ...
     <table cellpadding="0" cellspacing="0" style="width: 100%">
        ...
        <tr>
            ...
            <asp:DataGrid ID="dg_VehiclePermitGrid" runat="server"  
        ...
        <Columns>
                   ...
                   <asp:TemplateColumn HeaderText="Vehicle_ID"  Visible="False" >
                    ...
                    <asp:TemplateColumn HeaderText="Permit Type" SortExpression = "Permit_Type">
                        <ItemTemplate>
                            <asp:Label ID="lbl_PermitType" runat="server" Text='<%#Eval("Permit_Type")%>' ></asp:Label>                
                        </ItemTemplate>
                        <HeaderStyle  CssClass = "SORTINGLNKBTN"  />
                    </asp:TemplateColumn>
                    ...
                    <asp:TemplateColumn HeaderText="Task Completion Method" >
                        <ItemTemplate>
                           <asp:LinkButton ID="lnk_TaskList" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Task_Completion_Method")%>' OnClick="lnk_VehiclePermit_Click" ></asp:LinkButton>    
                        </ItemTemplate><HeaderStyle  CssClass  = "SORTINGLNKBTN"  />    
                    </asp:TemplateColumn>         
                    </Columns>           
        </asp:DataGrid>                             
