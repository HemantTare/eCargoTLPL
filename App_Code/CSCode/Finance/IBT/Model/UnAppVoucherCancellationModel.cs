...
{
    public class UnAppVoucherCancellationModel : ClassLibraryMVP.General.IModel
    {
        private IUnAppVoucherCancellationView objIUnAppVoucherCancellationView;
        private DataSet objDS;
        private DAL objDAL = new DAL();

        public UnAppVoucherCancellationModel(IUnAppVoucherCancellationView unAppVoucherCancellationView)
        {
