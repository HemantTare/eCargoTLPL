<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmAdmin.aspx.cs" Inherits="Display_FrmAdmin" %>
...
function LoadPopUp(Url)
{
    ...
    if (Url.indexOf("MgAyADcA") > 0) 
    {
        redirectPage = Url + "&orderno=0";
       ...
       <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    ...
                    <ComponentArt:NavBar id="NBAdmin" Width="186" 
                    CssClass="NAVBAR" 
