<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmBankDetailsSMS.aspx.cs"
    Inherits="Display_FrmBankDetailsSMS" %>
            ...
            <table class="TABLE" width="100%">
                <tr>
                    <td class="TDGRADIENT" colspan="2">
                        <asp:Label ID="lbl_Heading" CssClass="HEADINGLABEL" runat="server" Text="Bank Details"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td class="TD1" style="width: 40%; height: 15px;">
                        <asp:Label ID="lbl_BankH" runat="server" Font-Bold="true" Font-Size="Medium" ForeColor="DarkBlue"
                            Text="Select Bank :"></asp:Label>&nbsp;</td>
                    <td style="width: 60%; height: 15px;">
                        <asp:DropDownList ID="ddlBank" runat="server" CssClass="DROPDOWN" Width="52%">
                         <asp:ListItem Value="1">ICICI BANK LTD</asp:ListItem>
                        <asp:ListItem Value="2">BANK OF BARODA</asp:ListItem>
                        </asp:DropDownList></td>
                </tr>
                <tr>
                    <td class="TD1" style="width: 40%; height: 15px;">
