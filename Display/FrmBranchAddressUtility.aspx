<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmBranchAddressUtility.aspx.cs"
    Inherits="Display_FrmBranchAddressUtility" %>
            ...
            <table class="TABLE" width="100%">
                <tr>
                    <td class="TDGRADIENT" colspan="2">
                        <asp:Label ID="lbl_Heading" CssClass="HEADINGLABEL" runat="server" Text="Branch Address"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td class="TD1" style="width: 40%; height: 15px;">
                        <asp:Label ID="lbl_BranchH" runat="server" Font-Bold="true" Font-Size="Medium" ForeColor="DarkBlue"
                            Text="Select Branch :"></asp:Label>&nbsp;</td>
                    <td style="width: 60%; height: 15px;">
                        <asp:DropDownList ID="ddlBranch" runat="server" CssClass="DROPDOWN" Width="52%">
                        </asp:DropDownList></td>
                </tr>
                <tr>
                    <td class="TD1" style="width: 40%; height: 15px;">
