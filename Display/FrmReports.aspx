<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmReports.aspx.cs" Inherits="Display_FrmReports" %>
...
function LoadPopUp(Url)
{
    ...
    if (str.indexOf('NQAxADEAOQA') >= 0)
    { 
      window.open(Url, 'CustomPopUpBrchBkgReg<%=UserId%>', 'width='+ popW +', height='+ popH +',top='+ topPos +',left='+ leftPos +', menubar=no, resizable=no,scrollbars=yes')
    }
    else if (str.indexOf('NQAxADUAOQA') >= 0)
    { 
      window.open(Url, 'CustomPopUpDlyStk<%=UserId%>', 'width='+ popW +', height='+ popH +',top='+ topPos +',left='+ leftPos +', menubar=no, resizable=no,scrollbars=yes')
    }
    else if (str.indexOf('NQAxADUANwA') >= 0)
    { 
      window.open(Url, 'CustomPopUpBkgStk<%=UserId%>', 'width='+ popW +', height='+ popH +',top='+ topPos +',left='+ leftPos +', menubar=no, resizable=no,scrollbars=yes')
    }
    else
    {
       ...
       <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    ...
                    <ComponentArt:NavBar id="NBFinance" Width="186" 
                    CssClass="NAVBAR" 
