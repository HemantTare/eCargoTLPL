<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WucPODTrackNTraceCoverGenerationDetails.ascx.cs" Inherits="TrackNTrace_WucPODTrackNTraceCoverGenerationDetails" %>
...
<table width="100%">
    ...
    <tr runat="server" id="tr_att_PODCG_Details" >
        <td colspan="6" >
            <asp:Repeater ID="Rep_PODCGMasterDetails"  runat="server" OnItemDataBound="Rep_PODCGMasterDetails_ItemDataBound">
                <ItemTemplate>
                    <table width="100%">
                        <tr>
                            ...
                            <td class="AlphaValue" style="width:25%"><%#Eval("Cover_No_For_Print")%></td>
                            <td class="Feild" style="width:25%">
                                <asp:Label ID="lbl_Receipt_No" runat="server" CssClass="LABEL" Text="Receipt No"></asp:Label>
                                <asp:HiddenField ID="hdn_Receipt_Id" Value='<%#Eval("Cover_Received_ID")%>' runat="server" ></asp:HiddenField>
                            </td>
                            <td class="AlphaValue" style="width:25%">
                                 <asp:LinkButton ID="lnk_CR_No" Text='<%#Eval("Cover_Received_No_For_Print")%>' runat="server" ></asp:LinkButton>
                            </td> 
                        </tr>
                        <tr>
                            <td class="Feild" style="width:25%">
                        ...
                        <tr>
                            ...
                            <td class="AlphaValue" style="width:25%"><%#Eval("Despatch_From")%></td>
                             <td class="Feild" style="width:25%">
                                <asp:Label ID="lbl_Cover_Recvd_Hierarchy" runat="server" CssClass="LABEL" Text="Received At"></asp:Label>
                            </td>
        ...
        <td style="width:100%">
            <div style="width:100%;background-color:#DFE0F8">
                <table style="width:100%;">
                 <tr><td>&nbsp;</td></tr>
                 <tr>
                      <td class ="HeadingNoBGColor" colspan ="2">COVER GENERATION DETAILS</td>
                 </tr>
                 <tr>
