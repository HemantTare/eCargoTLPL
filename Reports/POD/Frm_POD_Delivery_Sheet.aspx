<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_POD_Delivery_Sheet.aspx.cs" Inherits="Reports_POD_Frm_POD_Delivery_Sheet" %>
...
<body>
    ...
    <table runat="server" id="Table1" class="TABLE">
     <tr>
        <td class="TDGRADIENT" style="width: 100%">
            <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="POD Delivery Sheet"></asp:Label>
        </td>
      </tr>
    </table>
            ...
            <td style="width: 100%">
                <table style="width: 100%">
                    <tr>
                        ...
                        <td style="width: 9%;" class="TD1">Employee:</td>
                        <td style="width: 24%;"><asp:DropDownList ID="ddl_Emp" runat="server" CssClass="DROPDOWN"></asp:DropDownList></td>
                        <td style="width: 9%;" class="TD1">Dcoument No:</td>
                        <td style="width: 24%;"><asp:TextBox ID="Txt_Doc_No" runat="server" CssClass="TEXTBOX" ></asp:TextBox></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table class="TABLE">
      <tr>
        <td >
          <asp:UpdatePanel ID="Upd_Pnl_POD_Delivery_Sheet" UpdateMode="Conditional" runat="server">
              <Triggers>
                  <asp:AsyncPostBackTrigger ControlID="dg_Grid" />
              </Triggers>
              <ContentTemplate>
                <asp:Panel ID="pnl_POD_Delivery_Sheet" runat="server" ScrollBars="Auto" Height="500px">
                  ...
                  <asp:DataGrid ID="dg_Grid"  runat="server" ShowFooter="True" AllowPaging="True" CssClass="GRID" AllowSorting="True"
                      ...
                      <Columns>
                        ...
                        <asp:BoundColumn DataField="POD Delivery Date" HeaderText="POD Delivery Date"></asp:BoundColumn> 
                        <asp:BoundColumn DataField="POD Document No" HeaderText="POD Document No"></asp:BoundColumn>
                        <asp:BoundColumn DataField="POD Document Date" HeaderText="POD Document Date"></asp:BoundColumn>
                        <asp:BoundColumn DataField="Payment Type" HeaderText="Bill Type"></asp:BoundColumn>  
