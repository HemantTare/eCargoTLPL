...
public partial class Reports_POD_Frm_POD_Delivery_Sheet : System.Web.UI.Page
{
    private DataSet ds;
    ...
    {
        Wuc_Export_To_Excel1.FileName = "PendingDeliverySheet";       
        if (IsPostBack == false)
        {
    ...
    {         
        ds = objCommon.Get_Values_Where("EC_Master_Employee", "Emp_id , First_Name + ' ' + Middle_name + ' ' +last_name as EmpNm", "Region_id = " + Wuc_Region_Area_Branch1.RegionID + " or Area_id = " + Wuc_Region_Area_Branch1.AreaID + " or branch_id = " + Wuc_Region_Area_Branch1.BranchID + "", "EMP_ID",true);
        BindEmp(ds);
        ddl_Emp.Items.Insert(0, new ListItem("All", "0"));
    }

    protected void BindEmp(DataSet ds)
    {
        ddl_Emp.DataSource = ds;
        ddl_Emp.DataValueField = "Emp_id";
        ddl_Emp.DataTextField = "EmpNm";
        ddl_Emp.DataBind();
    }
    ...
    private void BindGrid(object sender, EventArgs e)
    {
        ...
        SqlParameter[] objSqlParam ={ 
            ...
            objDAL.MakeInParams("@Empid",SqlDbType.Int,0,Util.String2Int(ddl_Emp.SelectedValue)),
            objDAL.MakeInParams("@Document_No",SqlDbType.VarChar,100,Txt_Doc_No.Text),
            objDAL.MakeInParams("@Division_Id",SqlDbType.Int,0,Division_ID),
            objDAL.MakeInParams("@PageIndex",SqlDbType.Int,0,grid_currentpageindex),
            objDAL.MakeInParams("@PageSize",SqlDbType.Int,0,grid_PageSize)
        };

        objDAL.RunProc("[EC_RPT_POD_DeliverySheet]", objSqlParam, ref ds);
