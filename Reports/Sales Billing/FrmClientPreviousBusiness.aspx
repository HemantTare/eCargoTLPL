<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmClientPreviousBusiness.aspx.cs"
    Inherits="Reports_Sales_Billing_FrmClientPreviousBusiness" %>
...
function viewwindow_OtherClientBusiness(ClientId,IsRegular)
{
        var Path='../../Reports/Sales Billing/FrmClientPreviousBusinessForSameMobileNo.aspx?Consignee_Client_ID=' + ClientId + '&Is_Consignee_Regular_Client=' + IsRegular;
        ...
        window.open(Path, 'OtherClientBusiness', 'width='+ popW +', height='+ popH +',top='+ topPos +',left='+ leftPos +', menubar=no, resizable=no,scrollbars=yes')
        return false;
}
    ...
    <form id="form1" runat="server">
        ...
        <table runat="server" id="tbl_input_screen" class="TABLE">
            ...
            <tr>
                <td style="width: 100%">
                    &nbsp;&nbsp; &nbsp;LR No. : &nbsp;
                    <asp:TextBox ID="txt_GCNo" runat="server" CssClass="TEXTBOX" Width="15%" MaxLength="10"></asp:TextBox>
                    <asp:Button ID="btn_view" CssClass="BUTTON" runat="server" OnClick="btn_view_Click"
                        Text="Go" /></td>
            </tr>
            <tr>
                <td style="width: 100%; height: 15px;">
        ...
        <table id="tbl_Header" runat="server" class="TABLE" style="background-color: Beige;
        ...
        <table id="tbl_LastBusiness" runat="server" class="TABLE">
            <tr>
                <td style="width: 60%; height: 15px; font-weight: bold; color: Purple; font-size: medium;"
                    align="Center">
                    Last 10 Bookings
                ...
                <td style="width: 40%; height: 15px; font-weight: bold; color: Purple; font-size: medium;"
                    align="Center">
        ...
        <table id="tbl_OtherClient" runat="server" class="TABLE">
            <tr>
                <td style="width: 100%; height: 15px; font-weight: bold; color: Purple; font-size: medium;"
                    align="Center">
                    Other Client With Same Mobile Nos.
                    <table width="100%">
                        <tr>
                            <td align="Left" style="width: 100%">
                                <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
                                    ...
                                    <ContentTemplate>
                                        <asp:Panel ID="Panel1" runat="server" Height="200px" ScrollBars="Auto">
                                            <asp:DataGrid ID="dg_Grid3" runat="server" ShowFooter="False" AllowPaging="False"
                                                CssClass="GRID" AllowSorting="True" AllowCustomPaging="False" AutoGenerateColumns="False"
                                                OnItemDataBound="dg_Grid3_ItemDataBound" PageSize="25">
                                                <AlternatingItemStyle CssClass="GRIDALTERNATEROWCSS" />
                                                <HeaderStyle CssClass="GRIDHEADERCSS" />
                                                <FooterStyle CssClass="GRIDFOOTERCSS" />
                                                <PagerStyle CssClass="GRIDPAGERCSS" Mode="NumericPages" />
                                                <Columns>
                                                    <asp:TemplateColumn HeaderText="Client Name">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnk_OtherClientName" runat="server" CssClass="LABEL" Text='<%# DataBinder.Eval(Container.DataItem, "Client_Name") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="Delivery Area" HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <%# DataBinder.Eval(Container.DataItem, "DeliveryAreaName")%>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="Category" HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <%# DataBinder.Eval(Container.DataItem, "Category_Name")%>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="Registered On" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <%# DataBinder.Eval(Container.DataItem, "Created_On")%>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="Business">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnk_OtherClientBusiness" runat="server" CssClass="LABEL" Text="Business" />
                                                        </ItemTemplate>
