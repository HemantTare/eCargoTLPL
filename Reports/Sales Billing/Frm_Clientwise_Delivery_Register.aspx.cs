...
public partial class Reports_Sales_Billing_Frm_Clientwise_Delivery_Register : System.Web.UI.Page
{
    private DataSet ds;
    private DAL objDAL = new DAL();

    decimal Gc_Amount,Invoice_Value;
    int Articles;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Wuc_Export_To_Excel1.FileName = "ClientwiseDeliveryRegister";
    ...
    protected void dg_Grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
    {
        ...
        {
            System.Web.UI.WebControls.Label lbl_Total, lbl_Articles, lbl_Gc_Amount, lbl_Invoice_Value;
    ...
    private void calculate_totals()
    {
        ...
        Articles = Util.String2Int(dr["Articles"].ToString());
    ...
    private void BindGrid(object sender, EventArgs e)
    {
        ...
        string Cnee_name = Txt_Consignor_name.Text;
        ...
        SqlParameter[] objSqlParam ={ 
            ...
            objDAL.MakeInParams("@Consignee_Name",SqlDbType.VarChar,100,Cnee_name),
            objDAL.MakeInParams("@DeliveryType", SqlDbType.Int,0,ddl_delivery_type.SelectedValue),           
            objDAL.MakeInParams("@Division_Id",SqlDbType.Int,0,Division_ID),
            objDAL.MakeInParams("@PageIndex",SqlDbType.Int,0,grid_currentpageindex),
            objDAL.MakeInParams("@PageSize",SqlDbType.Int,0,grid_PageSize)
        };

        objDAL.RunProc("[EC_RPT_ClientWise_Delivery_Register]", objSqlParam, ref ds);
