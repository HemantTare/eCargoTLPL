<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Rpt_Service_Tax_Details_Excel.aspx.cs" Inherits="Reports_Sales_Billing_Frm_Rpt_Service_Tax_Details_Excel" %>
                    ...
                    <tr>
                       <td style="width: 10%; " class="TD1" id="Division" runat="server">
                        ...
                        <td style="width: 9%;" class="TD1">
                            Service Tax Paid By:</td>
                        <td style="width: 24%;">
                            <asp:DropDownList ID="ddl_service_tax" runat="server" CssClass="DROPDOWN">
                                <asp:ListItem Value="2">Transpoter</asp:ListItem>
                      ...
                      <Columns>
                       ...
                       <asp:TemplateColumn HeaderText="Sub Total">
                          ...
                          <%# DataBinder.Eval(Container.DataItem, "Service_Tax_Amount")%>
                             ...
                             <FooterTemplate>
                              <asp:Label ID="lbl_Service_Tax_Amount" runat="server" CssClass="LABEL" Font-Bold="true"></asp:Label>
                          </FooterTemplate>
                          </asp:TemplateColumn>                          
                           <asp:TemplateColumn HeaderText="Total gc_caption Amount">
                           <ItemTemplate>                    
                          <%# DataBinder.Eval(Container.DataItem, "gccaption Amount")%>
                          </ItemTemplate>
                             <FooterTemplate>
