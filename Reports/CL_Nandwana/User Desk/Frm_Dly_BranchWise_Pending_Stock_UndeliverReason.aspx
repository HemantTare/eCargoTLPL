<%@ Page AutoEventWireup="true" CodeFile="Frm_Dly_BranchWise_Pending_Stock_UndeliverReason.aspx.cs"
    Inherits="Reports_CL_Nandwana_UserDesk_Frm_Dly_BranchWise_Pending_Stock_UndeliverReason"
    Language="C#" %>
...
<head runat="server">
    <title>Undelivered Reason</title>
        ...
        <table id="Table1" runat="server" class="TABLE">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Undelivered Reason"></asp:Label>
                </td>
            </tr>
        </table>
        <table class="TABLE">
            ...
            <tr>
                ...
                <td style="width: 80%; height: 15px;">
                    &nbsp;
                    <asp:DropDownList ID="ddl_Reason" runat="server" CssClass="DROPDOWN">
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td style="width: 20%; height: 15px;">
