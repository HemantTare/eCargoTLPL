<%@ Page AutoEventWireup="true" CodeFile="FrmPendingFreightBookingSummary.aspx.cs"
    Inherits="Reports_CL_Nandwana_UserDesk_FrmPendingFreightBookingSummary" Language="C#" %>
                        ...
                        <ContentTemplate>
                            <asp:Panel ID="pnl_DeliveryStockList" runat="server" Height="500px" ScrollBars="Auto">
                                <asp:DataGrid ID="dg_Details" runat="server" ShowFooter="True" AllowPaging="true"
                                    ...
                                    <Columns>
                                        <asp:TemplateColumn HeaderText="Bkg Branch" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lbtn_BkgBranch" Text='<%# DataBinder.Eval(Container, "DataItem.Branch_Name") %>'
                                                ...
                                                <asp:HiddenField ID="hdn_Booking_branch_Id" runat="server" Value='<%# DataBinder.Eval(Container, "DataItem.Branch_Id") %>' />
                                            </ItemTemplate>
