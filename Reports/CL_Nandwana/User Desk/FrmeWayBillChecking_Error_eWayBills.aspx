<%@ Page AutoEventWireup="true" CodeFile="FrmeWayBillChecking_Error_eWayBills.aspx.cs"
    Inherits="Reports_CL_Nandwana_UserDesk_FrmeWayBillChecking_Error_eWayBills" Language="C#" %>
...
<head runat="server">
    <title>eWayBillChecking Error eWayBills</title>
        ...
        <table id="Table1" runat="server" class="TABLE">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="eWayBillChecking Error eWayBills"></asp:Label>
                </td>
            </tr>
        </table>
                            ...
                            <asp:Panel ID="pnl_BillingDue" runat="server" Height="400px" ScrollBars="Auto">
                                <asp:DataGrid ID="dg_Details" runat="server" ShowFooter="true" AllowPaging="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="Reason" HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-Width="50%">
                                            <ItemTemplate>
