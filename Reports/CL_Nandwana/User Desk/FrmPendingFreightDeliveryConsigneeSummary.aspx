<%@ Page AutoEventWireup="true" CodeFile="FrmPendingFreightDeliveryConsigneeSummary.aspx.cs"
    Inherits="Reports_CL_Nandwana_UserDesk_FrmPendingFreightDeliveryConsigneeSummary"
    Language="C#" %>
...
//        var topPos = (h-popH)/2; 
        ...
        window.open(PathDlyStk, 'PendingFrtConsigneeSummary', 'width='+ popW +', height='+ popH +',top='+ topPos +',left='+ leftPos +', menubar=no, resizable=no,scrollbars=yes')
        return false;
}
...
<head runat="server">
    <title>Pending Freight Delivery Consignee Summary</title>
        ...
        <table id="Table1" runat="server" class="TABLE">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Pending Freight Delivery Consignee Summary"></asp:Label>
                </td>
            </tr>
        </table>
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 10%" class="TD1">
                                <asp:Label ID="lblDlyBranch" runat="server" Font-Bold="True" Text="Dly Branch :"></asp:Label></td>
                            <td style="width: 24%">
                                &nbsp;<asp:Label ID="txtlblDlyBranch" runat="server" Font-Bold="True" Text="Label"></asp:Label></td>
            ...
            <tr style="background-color: Yellow" align="center">
                <td style="height: 15px">
                    <asp:Label ID="lbl_Other" runat="server" CssClass="HEADINGLABEL" Font-Bold="true"
                        ForeColor="Navy" Text="For Delivery Branch"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                        ...
                        <ContentTemplate>
                            <asp:Panel ID="pnl_DeliveryStockList" runat="server" Height="150px" ScrollBars="Auto">
                                <asp:DataGrid ID="dg_Details" runat="server" ShowFooter="True" AllowPaging="True"
                                    ...
                                    <Columns>
                                        <asp:TemplateColumn HeaderText="Consignee" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lbtn_Consignee" Text='<%# DataBinder.Eval(Container, "DataItem.Consignee_Name") %>'
                                        ...
                                        <asp:BoundColumn DataField="DlyDate" HeaderText="Delivery Date" HeaderStyle-Width="10%">
                                        </asp:BoundColumn>
