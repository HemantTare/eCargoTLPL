<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmeWayBillsExpiringTodaySummary.aspx.cs"
    Inherits="Reports_CL_Nandwana_User_Desk_FrmeWayBillsExpiringTodaySummary" %>
...
<head runat="server">
    <title>eWay Bills Expiring Today Summary</title>
        ...
        <table runat="server" id="Table1" class="TABLE">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="eWay Bills Expiring Today"></asp:Label>
                </td>
            </tr>
        </table>
                            ...
                            <div class="DIV1" style="height: 400px; width: 60%;">
                                <asp:DataGrid ID="dg_Grid" runat="server" ShowFooter="false" ItemStyle-HorizontalAlign="Left"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="DlyBranch" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lbtn_Branch" Text='<%# DataBinder.Eval(Container, "DataItem.DlyBranch") %>'
                                                    Font-Bold="True" Font-Underline="True" runat="server" CommandName="Description"
                                                    CommandArgument='<%# DataBinder.Eval(Container, "DataItem.DlyBranch") %>' />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateColumn>
                                        <asp:BoundColumn DataField="NoOfeWayBill" HeaderText="eWay Bills" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ></asp:BoundColumn>
                                    </Columns>
                                </asp:DataGrid>
                            </div>
                        </ContentTemplate>
