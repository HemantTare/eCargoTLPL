<%@ Page AutoEventWireup="true" CodeFile="FrmeWayBillChecking_Consolidated_eWayBills.aspx.cs"
    Inherits="Reports_CL_Nandwana_UserDesk_FrmeWayBillChecking_Consolidated_eWayBills"
    Language="C#" %>
...
<head runat="server">
    <title>eWayBillChecking Consolidated eWayBills</title>
        ...
        <table id="Table1" runat="server" class="TABLE">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="eWayBillChecking Consolidated eWayBills"></asp:Label>
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td style="width: 50%">
                    <asp:UpdatePanel ID="Upd_Pnl_BillingDue" UpdateMode="Conditional" runat="server">
                        ...
                        <ContentTemplate>
                            <asp:Panel ID="pnl_BillingDue" runat="server" Height="700px" ScrollBars="Auto">
                                <asp:DataGrid ID="dg_Details" runat="server" ShowFooter="true" AllowPaging="false"
                                    ...
                                    <Columns>
                                        <asp:TemplateColumn HeaderText="Consol. eWayBilll No." HeaderStyle-HorizontalAlign="Center"  ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <%# DataBinder.Eval(Container.DataItem, "Consolidated_eWayBillNo")%>
                                            </ItemTemplate>
