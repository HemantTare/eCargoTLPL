<%@ Page AutoEventWireup="true" CodeFile="FrmeWayBill_Pending_Vehicle_Update_PDS.aspx.cs"
    Inherits="Reports_CL_Nandwana_UserDesk_FrmeWayBill_Pending_Vehicle_Update_PDS"
    Language="C#" %>
...
function viewwindow_Vehicle_Update_Json_Creation_PDS(PathDlyStk)
{
    ...
    window.open(PathDlyStk, 'Vehicle_Update_Json_Creation_PDS', 'width='+ popW +', height='+ popH +',top='+ topPos +',left='+ leftPos +', menubar=no, resizable=no,scrollbars=yes')
//    self.close();
    return false;
}
...
function viewwindow_general(PDS_Id)
{
        ...
        window.open(Path, 'CustomPopUpUnVerifiedPDS', 'width='+ popW +', height='+ popH +',top='+ topPos +',left='+ leftPos +', menubar=no, resizable=no,scrollbars=yes')
        return false;
}
...
<head runat="server">
    <title>Pending eWay Bill Vehicle Update PDS</title>
        ...
        <table id="Table1" runat="server" class="TABLE">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Pending eWay Bill Vehicle Update PDS"></asp:Label>
                </td>
            </tr>
        </table>
