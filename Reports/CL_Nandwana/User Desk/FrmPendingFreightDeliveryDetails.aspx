<%@ Page AutoEventWireup="true" CodeFile="FrmPendingFreightDeliveryDetails.aspx.cs"
    Inherits="Reports_CL_Nandwana_UserDesk_FrmPendingFreightDeliveryDetails" Language="C#" %>
...
function Check_Single(chkid,gridname)
    {
        ...
        txt_TotalFreight = row.cells[5].getElementsByTagName('input')[0].value;
        if(chk.checked == true)
        {
    ...
    <form id="form1" runat="server">
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td style="width: 5%" class="TD1">
                                <asp:Label ID="lblDlyBranch" runat="server" Text="Branch :" CssClass="TEXTBOX" Font-Bold="True"></asp:Label></td>
                            <td style="width: 14%">
                                <asp:Label ID="txtlblDlyBranch" runat="server" Text="txtlblDlyBranch" CssClass="TEXTBOX"
                                    Font-Bold="True"></asp:Label></td>
                            <td class="TD1" style="width: 10%">
                                <asp:Label ID="lblConsignee" runat="server" Text="Consignee :" CssClass="TEXTBOX"
                                    Font-Bold="True"></asp:Label></td>
                            <td style="width: 38%">
                                <asp:Label ID="txtlblConsignee" runat="server" Text="txtlblConsignee" CssClass="TEXTBOX"
                                    Font-Bold="True"></asp:Label></td>
                            <td style="width: 9%">
                            ...
                            <asp:Panel ID="pnl_DeliveryStockList" runat="server" Height="420px" ScrollBars="Auto">
                                <asp:DataGrid ID="dg_Grid" runat="server" ShowFooter="True" AllowPaging="True" CssClass="GRID"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="DDC_Date" HeaderText="DDC Date"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="DDCNo" HeaderText="DDC No"></asp:BoundColumn>
                                        ...
                                        <asp:BoundColumn DataField="Vehicle_No" HeaderText="Tempo No"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="DriverName" HeaderText="Driver"></asp:BoundColumn>
        ...
        <table class="TABLE" width="100%">
            ...
            <tr id="tr_Paymentdetails5" runat="server">
                <td style="width: 25%; text-align: right; height: 26px;">
                    <asp:Label ID="lbl_TDS" runat="server" Font-Bold="True" Text="TDS Deducted By Party : "
