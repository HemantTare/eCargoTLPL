<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmeWayBill_Pending_Vehicle_Update_Json_Creation.aspx.cs"
    Inherits="Reports_CL_Nandwana_UserDesk_FrmeWayBill_Pending_Vehicle_Update_Json_Creation" %>
...
<head runat="server">
    <title>eWayBill Pending Vehicle Update JSON Creation</title>
            ...
            <table class="TABLE" style="width: 100%; background-color: LightPink">
                <tr>
                    <td class="TDGRADIENT" colspan="3" style="height: 16px">
                        <asp:Label ID="lbl_Heading" CssClass="HEADINGLABEL" runat="server" Text="eWayBill Pending Vehicle Update JSON Creation"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr id="tr_Message" runat="server" visible="false">
                    <td colspan="3" align="center">
                        <asp:Label ID="lbl_Message" CssClass="LABEL" Text="This Vehicle Having Unverified eWayBills Without Proper Reason. Can't Create Json For This Vehicle."
                            runat="server" ForeColor="#660066" Font-Size="Large" Font-Bold="true"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="TD1" style="width: 30%;">
                                    ...
                                    <asp:DataGrid ID="dg_BranchMobileNos" runat="server" AllowCustomPaging="False" AllowPaging="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateColumn HeaderStyle-HorizontalAlign="Left" HeaderText="BranchID" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblBranchID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Memo_Branch_ID")%>'></asp:Label>
                                                </ItemTemplate>
                    ...
                    <td>
                        &nbsp;<asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <asp:HiddenField ID="hdnCurrent_Memo_IDs" runat="server" />
                            </ContentTemplate>
                            <Triggers>
