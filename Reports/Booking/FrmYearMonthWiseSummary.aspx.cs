...
public partial class Reports_Booking_FrmYearMonthWiseSummary : System.Web.UI.Page
{
    #region Declaration
    private DataSet ds;
    ...
    public int MONTHID
    {
        get { return Convert.ToInt32(ViewState["_Month_ID"]); }
        set { ViewState["_Month_ID"] = value; }
    }
    ...
    //public int YearID
    //{
    //    get { return Convert.ToInt32(ViewState["_Year_ID"]); }
    //    set
    //    { 
    //        ViewState["_Year_ID"] = value;
    //        lblYearID.Text = Convert.ToString(value);
    //    }
    //}
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        Wuc_Export_To_Excel1.btn_export_to_excel_click += new EventHandler(BindGrid);
            ...
            Wuc_Export_To_Excel1.FileName = "DateWiseBookingSummary";
        ...
        if (IsPostBack == false)
        {
            ...
            //Crypt = Request.QueryString["YearID"];
            //YearID = ClassLibraryMVP.Util.DecryptToInt(Crypt);
    ...
    private void PrepareDTForExportToExcel()
    {
        ...
        {
            ds.Tables[0].Columns["ClientName"].ColumnName = "Date";
        }
    ...
    protected void dg_Grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
    {
        ...
        //    lnk_ClientName.Attributes.Add("onclick", "return viewwindow_general('" + ClassLibraryMVP.Util.EncryptInteger(RegionID) + "','" + ClassLibraryMVP.Util.EncryptInteger(AreaID) + "','" + ClassLibraryMVP.Util.EncryptInteger(BranchID) + "','" + IsConsignorWise + "','" + From_Date + "','" + To_Date + "','" + ClassLibraryMVP.Util.EncryptString(Name) + "','" + ClassLibraryMVP.Util.EncryptInteger(Division_ID) + "','" + ClassLibraryMVP.Util.EncryptInteger(Client_ID) + "','" + ClassLibraryMVP.Util.EncryptInteger(MONTHID) + "','" + ClassLibraryMVP.Util.EncryptInteger(YearID) + "')");
