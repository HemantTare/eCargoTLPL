<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Transit_Stock_Report.aspx.cs" Inherits="Reports_Booking_Frm_Transit_Stock_Report" %>
        ...
        <table id="Table1" runat="server" class="TABLE">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Transit Stock List"></asp:Label>
                </td>
            </tr>
        </table>
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td style="width: 10%" class="TD1">
                                <asp:Label ID="lbl_division" runat="server" CssClass="LABEL" Text="label"></asp:Label></td>
                               ...
                               <asp:TemplateColumn HeaderText="gc_caption Date">
                                ...
                                <asp:TemplateColumn HeaderText="Total Freight" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                  ...
                                  <asp:TemplateColumn HeaderText="Invoice Value" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                    ...
                                    <FooterTemplate>
                                        <asp:Label ID="lbl_Invoice_Value" runat="server" CssClass="LABEL" Font-Bold="true"></asp:Label>
                                    </FooterTemplate>
                                </asp:TemplateColumn>
                                 <asp:BoundColumn DataField="LHPO No" HeaderText="LHC No"></asp:BoundColumn> 
                                   <asp:BoundColumn DataField="LHPO Date" HeaderText="LHC Date"></asp:BoundColumn> 
                                     <asp:BoundColumn DataField="LHC Frm Location" HeaderText="LHC Frm Location"></asp:BoundColumn> 
                                       <asp:BoundColumn DataField="LHC To Location" HeaderText="LHC To Location"></asp:BoundColumn> 
                                </Columns>
                            </asp:DataGrid>
                        </asp:Panel>
                  </ContentTemplate>
