<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmBrchWiseBkgRegPaidTBBView.aspx.cs"
    Inherits="Reports_Booking_FrmBrchWiseBkgRegPaidTBBView" %>
...
{ 
  ...
  window.open(Path + "&From_Date=" + From_Date.value + "&To_Date=" + To_Date.value,'PaidTBB','width=1000,height=800,top=50,left=50,menubar=no,resizable=yes,scrollbars=yes')
  return false;
}
</script>
...
<head runat="server">
    <title>Branch Wise Booking Register Paid - TBB View</title>
        ...
        <table class="TABLE">
            <tr>
                <td colspan="5" class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="Label1" runat="server" CssClass="HEADINGLABEL" Text="Branch wise Booking Register Paid - TBB"></asp:Label>
                </td>
            </tr>
            <tr>
