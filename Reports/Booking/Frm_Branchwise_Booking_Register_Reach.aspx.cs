...
public partial class Reports_Booking_Frm_Branchwise_Booking_Register_Reach : System.Web.UI.Page
{
    #region Declaration
    private DataSet ds;
    decimal ChargedWeight, Actual_Weight, Articles, Freight, Lorry_Hire_Charge,No_of_CN,All_OtherCharges,ServiceTaxAmount,Total_Freight;
   ...
   protected void dg_Grid_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        if (e.Item.ItemType == System.Web.UI.WebControls.ListItemType.Footer)
        {
            System.Web.UI.WebControls.Label lbl_ChargedWeight,
                ...
                lbl_AllOtherCharges, lbl_ServiceTaxAmount, lbl_TotalFreight;
    ...
    private void calculate_totals()
    {
        ...
        No_of_CN = Util.String2Decimal(dr["gc_caption No"].ToString());
    ...
    private void BindGrid(object sender, EventArgs e)
    {
        ...
        objDAL.RunProc("[EC_RPT_Branchwise_Booking_Register_Reach_GRD]", objSqlParam, ref ds);
        ...
        {
            dg_GridSummary.VirtualItemCount = Util.String2Int(ds.Tables[2].Rows[0][0].ToString());
            calculate_totals();
