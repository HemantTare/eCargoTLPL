<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmConsignorConsigneeWiseSummary.aspx.cs"
    Inherits="Reports_Booking_FrmConsignorConsigneeWiseSummary" %>
...
function viewwindow_general(RegionID,AreaID,BranchID,IsConsignorWise,From_Date,To_Date,StartDate,EndDate,Name,Division_ID,Client_Name,MONTHID,MONTHNAME,YearID)
{ 

        var Path='../../Reports/Booking/FrmYearMonthWiseSummary.aspx?RegionID=' + RegionID + '&AreaID=' + AreaID + '&BranchID=' + BranchID + '&IsConsignorWise=' + IsConsignorWise + '&From_Date=' + From_Date + '&To_Date=' + To_Date + '&StartDate=' + StartDate + '&EndDate=' + EndDate + '&Name=' + Name + '&Division_ID=' + Division_ID + '&Client_Name=' + Client_Name + '&MONTHID=' + MONTHID + '&MONTHNAME=' + MONTHNAME + '&YearID=' + YearID;
...
<head runat="server">
    <title>Consignor/Consignee Wise Booking Summary</title>
        ...
        <table runat="server" id="Table1" class="TABLE" >
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Consignor/Consignee Wise Booking Summary"></asp:Label>
                </td>
            </tr>
            <tr>
