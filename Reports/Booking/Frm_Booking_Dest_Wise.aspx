<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Booking_Dest_Wise.aspx.cs"
    Inherits="Reports_Booking_Frm_Booking_Dest_Wise" %>
        ...
        <table runat="server" id="tbl_input_screen" class="TABLE">
            <tr>
                <td class="TDGRADIENT" colspan="5">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL"></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <asp:ListItem Text ="Booking Branch Wise" Value ="true" Selected ="True"></asp:ListItem>
