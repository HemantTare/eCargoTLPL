<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmCrossingStockList.aspx.cs" Inherits="Reports_Booking_FrmCrossingStockList" %>
        ...
        <table id="Table1" runat="server" class="TABLE">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Crossing Stock List"></asp:Label>
                </td>
            </tr>
        </table>
