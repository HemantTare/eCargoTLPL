<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Branchwise_Booking_Register_Reach.aspx.cs" Inherits="Reports_Booking_Frm_Branchwise_Booking_Register_Reach" %>
              ...
              <ContentTemplate>                
                  <asp:DataGrid ID="dg_Grid"  runat="server" ShowFooter="true"
                     ...
                     <asp:BoundColumn DataField="gc_caption Date" HeaderText="gc_caption Date"></asp:BoundColumn>
                      ...
                      <asp:BoundColumn DataField="DDC Date" HeaderText="DDC Date"></asp:BoundColumn>
