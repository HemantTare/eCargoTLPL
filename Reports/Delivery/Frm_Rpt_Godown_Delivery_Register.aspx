<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Rpt_Godown_Delivery_Register.aspx.cs"
    Inherits="Reports_Booking_Delivery_Frm_Rpt_Godown_Delivery_Register" %>
        ...
        <table runat="server" id="tbl_input_screen" class="TABLE">
            <tr>
                <td class="TDGRADIENT" colspan="5">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Godown Delivery Register" ></asp:Label>
                </td>
            </tr>
            <tr>
