<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_DDC_TempoFreight_Rpt.aspx.cs"
    Inherits="Reports_Delivery_Frm_DDC_TempoFreight_Rpt" %>
        ...
        <table class="TABLE">
            <tr>
                <td colspan="5" class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="Label1" runat="server" CssClass="HEADINGLABEL" Text="DDC Tempo Freight"></asp:Label>
                </td>
            </tr>
            <tr>
