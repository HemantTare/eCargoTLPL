<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_DDC_TempoFreight_Vouchers_Rpt.aspx.cs"
    Inherits="Reports_Delivery_Frm_DDC_TempoFreight_Vouchers_Rpt" %>
...
{ 
  ...
  var Region_Name = ddl_region.options[ddl_region.selectedIndex].text; 
  var Area_Name = ddl_Area.options[ddl_Area.selectedIndex].text; 
  var Branch_Name = ddl_Branch.options[ddl_Branch.selectedIndex].text; 
  
  window.open(Path + "&Region_Name=" + Region_Name + "&Area_Name=" + Area_Name + "&Branch_Name=" + Branch_Name + "&From_Date=" + From_Date.value + "&To_Date=" + To_Date.value,'DDCTempoFreight','width=1000,height=800,top=50,left=50,menubar=no,resizable=yes,scrollbars=yes')
  return false;
}
        ...
        <table class="TABLE">
            <tr>
                <td colspan="5" class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="Label1" runat="server" CssClass="HEADINGLABEL" Text="DDC Tempo Freight Vouchers"></asp:Label>
                </td>
            </tr>
            <tr>
