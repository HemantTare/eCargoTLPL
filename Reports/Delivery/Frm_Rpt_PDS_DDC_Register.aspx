<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Rpt_PDS_DDC_Register.aspx.cs"
    Inherits="Reports_Booking_Delivery_Frm_Rpt_PDS_DDC_Register" %>
        ...
        <table runat="server" id="tbl_input_screen" class="TABLE">
            <tr>
                <td class="TDGRADIENT" colspan="5">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Door Delivery Register" ></asp:Label>
                </td>
            </tr>
            <tr>
