...
public partial class Reports_Booking_Delivery_Frm_Rpt_PDS_DDC_Register : System.Web.UI.Page
{
    #region Declaration
    private DataSet ds;
    int _Menu_Item_Id;
    ...
    private void CommonSetting()
    {
        ...
        {
            this.Title = "PDS DDC Register";
            lbl_Heading.Text = "PDS DDC Register";
        } 
    }
    ...
    protected void btn_view_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Path.Append("Reports/Delivery/PDS_DDC_Register_ReportsViewer.aspx?Menu_Item_Id=" + Util.EncryptInteger(Raj.EC.Common.GetMenuItemId())
