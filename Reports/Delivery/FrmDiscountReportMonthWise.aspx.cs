...
public partial class Reports_Delivery_FrmDiscountReportMonthWise : System.Web.UI.Page
{
    #region Declaration
    private DataSet ds; 
    ...
    public int YearID
    {
        get { return Convert.ToInt32(ViewState["_YearID"]); }
        set { ViewState["_YearID"] = value; }
    } 
    ...
    protected void dg_Grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
    {
        ...
        if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            lnk_Date = (LinkButton)e.Item.FindControl("lnk_Date");
            MONTHNAME = lnk_Date.Text;

            lnk_Date.Attributes.Add("onclick", "return viewwindow_general('" + ClassLibraryMVP.Util.EncryptInteger(RegionID) + "','" + ClassLibraryMVP.Util.EncryptInteger(AreaID) + "','" + ClassLibraryMVP.Util.EncryptInteger(BranchID) + "','" + From_Date + "','" + To_Date + "','" + StartDate + "','" + EndDate + "','" + ClassLibraryMVP.Util.EncryptString(Name) + "','" + ClassLibraryMVP.Util.EncryptInteger(MONTHID) + "','" + ClassLibraryMVP.Util.EncryptString(MONTHNAME) + "','" + ClassLibraryMVP.Util.EncryptString(lnk_Date.Text) + "')");
