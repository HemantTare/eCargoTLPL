...
public partial class Reports_Booking_Delivery_Frm_Rpt_Godown_Delivery_Register : System.Web.UI.Page
{
    #region Declaration
    private DataSet ds;
    int _Menu_Item_Id;
    ...
    private void CommonSetting()
    {
        ...
        {
            this.Title = "Godown Delivery Register";
            lbl_Heading.Text = "Godown Delivery Register";
        } 
    }
    ...
    protected void btn_view_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Path.Append("Reports/Delivery/Godown_Delivery_Register_ReportsViewer.aspx?Menu_Item_Id=" + Util.EncryptInteger(Raj.EC.Common.GetMenuItemId())
