<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Branchwise_Inward_Summary.aspx.cs"
    Inherits="Reports_Booking_Inward_Frm_Branchwise_Inward_Summary" %>
        ...
        <table runat="server" id="tbl_input_screen" class="TABLE">
            <tr>
                <td class="TDGRADIENT" colspan="5">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Branchwise Inward Summary"></asp:Label>
                </td>
            </tr>
            <tr>
