...
public partial class Reports_Booking_Inward_Frm_AgentBranch_Commission : System.Web.UI.Page
{
    #region Declaration
    private DataSet ds;
    int _Menu_Item_Id;
    ...
    private void CommonSetting()
    {
        ...
        {
            this.Title = "Agent Branch Commission";
            lbl_Heading.Text = "Agent Branch Commission";
        } 
    }
    ...
    protected void btn_view_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Path.Append("Reports/Inward/AgentBranch_Commission_ReportsViewer.aspx?Menu_Item_Id=" + Util.EncryptInteger(Raj.EC.Common.GetMenuItemId())
