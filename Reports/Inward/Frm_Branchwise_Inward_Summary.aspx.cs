...
public partial class Reports_Booking_Inward_Frm_Branchwise_Inward_Summary : System.Web.UI.Page
{
    #region Declaration
    private DataSet ds;
    int _Menu_Item_Id;
    ...
    private void CommonSetting()
    {
        ...
        {
            this.Title = "Branch Wise Inward Summary";
            lbl_Heading.Text = "Branch Wise Inward Summary";
        } 
    }
    ...
    protected void btn_view_Click(object sender, EventArgs e)
    {
        DateCommon objDateCommon = new DateCommon();
            ...
            Path.Append("Reports/Inward/Branchwise_Inward_Summary_ReportsViewer.aspx?Menu_Item_Id=" + Util.EncryptInteger(Raj.EC.Common.GetMenuItemId())
