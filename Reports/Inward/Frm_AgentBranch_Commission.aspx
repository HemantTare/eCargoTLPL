<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_AgentBranch_Commission.aspx.cs"
    Inherits="Reports_Booking_Inward_Frm_AgentBranch_Commission" %>
        ...
        <table runat="server" id="tbl_input_screen" class="TABLE">
            <tr>
                <td class="TDGRADIENT" colspan="5">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Agent Branch Commission" ></asp:Label>
                </td>
            </tr>
            <tr>
