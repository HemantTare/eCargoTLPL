<%@ Page AutoEventWireup="true" CodeFile="Frm_Rpt_GSTR1_B2B.aspx.cs" Inherits="Reports_GSTR1_Frm_Rpt_GSTR1_B2B"
    Language="C#" %>
        ...
        <table id="Table1" runat="server" class="TABLE">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="GSTR 1 - B2B"></asp:Label>
                </td>
            </tr>
        </table>
                            ...
                            <asp:Panel ID="pnl_DeliveryStockList" runat="server" Height="500px" ScrollBars="Auto">
                                <asp:DataGrid ID="dg_Grid" runat="server" ShowFooter="True" AllowPaging="True" CssClass="GRID"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="GSTPayingParty" HeaderText="GSTPayingParty"></asp:BoundColumn>
