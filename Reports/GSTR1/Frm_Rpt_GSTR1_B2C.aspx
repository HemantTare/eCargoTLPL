<%@ Page AutoEventWireup="true" CodeFile="Frm_Rpt_GSTR1_B2C.aspx.cs" Inherits="Reports_GSTR1_Frm_Rpt_GSTR1_B2C"
    Language="C#" %>
        ...
        <table id="Table1" runat="server" class="TABLE">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="GSTR 1 - B2C"></asp:Label>
                </td>
            </tr>
        </table>
                                        ...
                                        <ContentTemplate>
                                            <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                                                <asp:DataGrid ID="dg_Grid1" runat="server" ShowFooter="True" AllowPaging="False"
                                                    ...
                                                    <Columns>
                                                        <asp:BoundColumn DataField="SupplyType" HeaderText="SupplyType"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="PlaceOfSupply" HeaderText="PlaceOfSupply"></asp:BoundColumn>
                                                        <asp:TemplateColumn HeaderText="SubTotal">
                                                            <ItemTemplate>
                                                                <%# DataBinder.Eval(Container.DataItem, "SubTotal")%>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                <asp:Label ID="lbl_SumTotalSubTotal1" runat="server" CssClass="LABEL" Font-Bold="true"></asp:Label>
                                                            </FooterTemplate>
