<%@ Page AutoEventWireup="true" CodeFile="Frm_Rpt_GSTR1_Series.aspx.cs" Inherits="Reports_GSTR1_Frm_Rpt_Series"
    Language="C#" %>
        ...
        <table id="Table1" runat="server" class="TABLE">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="GSTR 1 - Series"></asp:Label>
                </td>
            </tr>
        </table>
                            ...
                            <asp:Panel ID="pnl_DeliveryStockList" runat="server" Height="500px" ScrollBars="Auto">
                                <asp:DataGrid ID="dg_Grid" runat="server" ShowFooter="False" AllowPaging="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="Start_LRNo" HeaderText="Start LRNo"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="End_LRNo" HeaderText="End_LRNo"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="Total_LR" HeaderText="Total LR"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="Cancelled" HeaderText="Total Cancelled"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="CancelledLR" HeaderText="Cancelled Nos"></asp:BoundColumn>
                                    </Columns>
                                </asp:DataGrid>
                            </asp:Panel>
                        </ContentTemplate>
