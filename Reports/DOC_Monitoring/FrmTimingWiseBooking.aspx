<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmTimingWiseBooking.aspx.cs"
    Inherits="Reports_DOC_Monitoring_FrmTimingWiseBooking" %>
            ...
            <tr>
                <td>
                    <asp:UpdatePanel ID="Upd_Pnl_BookingRegister" UpdateMode="Conditional" runat="server">
                        ...
                        <ContentTemplate>
                            <div class="DIV" style="height: 510px; width: 1000px;">
                                <asp:DataGrid ID="dg_Grid" runat="server" ShowFooter="true" AllowPaging="True" AllowCustomPaging="true"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="CreatedTime" HeaderText="Time"></asp:BoundColumn>
                                        ...
                                        <asp:BoundColumn DataField="Consignor_Name" HeaderText="Consignor" >
                                        <ItemStyle HorizontalAlign="Left" />
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="Total_Articles" HeaderText="No. of<br/>Packages"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="Emp_Name" HeaderText="Operator"></asp:BoundColumn>
