...
public partial class Reports_Operation_Frm_ShortExcess_Supervisorwise : System.Web.UI.Page
{
    private DataSet ds;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Wuc_From_To_Datepicker1.Set_FromDate_Caption = "AUS From Date:";
        Wuc_From_To_Datepicker1.Set_ToDate_Caption = "AUS To Date:";

        Wuc_Export_To_Excel1.FileName = "Short-ExcessSupervisorwise";
    ...
    protected void dg_Grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
    {
        ...
        {
            System.Web.UI.WebControls.Label lbl_Total, lbl_Articles;
    ...
    private void BindGrid(object sender, EventArgs e)
    {
        ...
        SqlParameter[] objSqlParam ={ 
            ...
            objDAL.MakeInParams("@FILTER_TYPE_ID",SqlDbType.Int,0,type),
        ...
        objDAL.RunProc("[EC_RPT_SHORT_EXCESS_SUPERVISOR]", objSqlParam, ref ds);
