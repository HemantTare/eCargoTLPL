...
public partial class Reports_Operation_Frm_Truck_Loading_Report : System.Web.UI.Page
{
    private DataSet ds;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Wuc_Export_To_Excel1.FileName = "TruckLoadingReport";
        if (IsPostBack == false)
        {
    ...
    private void BindGrid(object sender, EventArgs e)
    {
        ...
        SqlParameter[] objSqlParam ={ 
            ...
            objDAL.RunProc("[EF_RPT_Truck_Loading_GRD]", objSqlParam, ref ds);
