<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Truck_Loading_Report.aspx.cs" Inherits="Reports_Operation_Frm_Truck_Loading_Report" %>
...
<body>
   ...
   <asp:ScriptManager ID="scm_Truck_Loading" runat="server"></asp:ScriptManager>

    <table runat="server" id="Table1" class="TABLE">
     <tr>
        <td class="TDGRADIENT" style="width: 100%">
            <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Truck Loading Report"></asp:Label>
        </td>
      </tr>
    </table>
    ...
    <table class="TABLE">
      <tr>
        <td>
          <asp:UpdatePanel ID="Upd_Pnl_Truck_Loading" UpdateMode="Conditional" runat="server">
              <Triggers>
              ...
              <%--  <asp:Panel ID="pnl_BookingRegister" runat="server" ScrollBars="Auto" Height="500px">--%>
                  ...
                  <asp:DataGrid ID="dg_Grid"  runat="server" ShowFooter="True" AllowPaging="True" AllowCustomPaging="true"
                   CssClass="GRID" AllowSorting="True"
                      ...
                      <Columns>
                      <asp:BoundColumn DataField="Loading From AO" HeaderText="Loading From AO"></asp:BoundColumn> 
                          <asp:BoundColumn HeaderText="Loading From Branch/Hub" DataField="Loading From Branch/Hub"></asp:BoundColumn>
                      ...
                      <asp:BoundColumn DataField="lhpo_caption Last Branch" HeaderText="lhpo_caption Last Branch"></asp:BoundColumn> 
                      <asp:BoundColumn DataField="lhpo_caption Destination A0" HeaderText="lhpo_caption Destination A0"></asp:BoundColumn> 
                          <asp:TemplateColumn HeaderText="No of Memos" ItemStyle-HorizontalAlign ="Right" FooterStyle-HorizontalAlign="Right">
                           <ItemTemplate>                    
                          ...
                          <asp:TemplateColumn HeaderText="No of gc_caption's" ItemStyle-HorizontalAlign ="Right" FooterStyle-HorizontalAlign="Right">
                           <ItemTemplate>                    
                      ...
                      <asp:TemplateColumn HeaderText="Sub Freight" ItemStyle-HorizontalAlign ="Right" FooterStyle-HorizontalAlign="Right">
                          ...
                          <asp:TemplateColumn HeaderText="Truck Hire Charge" ItemStyle-HorizontalAlign ="Right" FooterStyle-HorizontalAlign="Right">
                          <ItemTemplate>                    
                          ...
                          <asp:TemplateColumn HeaderText="Advance" ItemStyle-HorizontalAlign ="Right" FooterStyle-HorizontalAlign="Right">
                           <ItemTemplate>                    
                          ...
                          <asp:TemplateColumn HeaderText="Truck Capacity" ItemStyle-HorizontalAlign ="Right" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>                    
                          ...
                          <asp:TemplateColumn HeaderText="Short / Excess" ItemStyle-HorizontalAlign ="Right" FooterStyle-HorizontalAlign="Right">
                           <ItemTemplate >                    
