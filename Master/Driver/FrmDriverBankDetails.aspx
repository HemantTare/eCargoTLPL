<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmDriverBankDetails.aspx.cs"
    Inherits="Master_Driver_FrmDriverBankDetails" EnableViewState="true" %>
...
<head runat="server">
    <title>Driver Bank Details</title>
            ...
            <table class="TABLE" width="100%">
                <tr>
                    <td class="TDGRADIENT" colspan="3" style="height: 16px">
                        <asp:Label ID="lbl_Heading" CssClass="HEADINGLABEL" runat="server" Text="Driver Bank Details"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="TD1" style="width: 20%">
                        Driver</td>
                    <td style="width: 79%">
                        &nbsp;<asp:Label ID="lbl_Driver" runat="server" CssClass="TEXTBOX" Width="50%"></asp:Label></td>
                    <td class="TDMANDATORY" style="width: 1%">
                        *</td>
                </tr>
                <tr>
