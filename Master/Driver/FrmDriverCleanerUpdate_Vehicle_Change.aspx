<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmDriverCleanerUpdate_Vehicle_Change.aspx.cs"
    Inherits="Master_Driver_FrmDriverCleanerUpdate_Vehicle_Change" %>
...
<head runat="server">
    <title>Driver Cleaner Update - Vehicle Change</title>
            ...
            <table class="TABLE" width="100%">
                <tr>
                    <td class="TDGRADIENT" colspan="6">
                        <asp:Label ID="lbl_Heading" CssClass="HEADINGLABEL" runat="server" Text="Driver Cleaner Update - Vehicle Change"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 29%">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txtVehicleNew" autocomplete="off" runat="server" CssClass="TEXTBOX"
                                    onblur="On_txtLostFocus('txtVehicleNew','lstVehicleNew','hdn_VehicleIdNew'); txtbox_onlostfocus(this);"
                                    onkeyup="Search_txtSearch(event,this,'lstVehicleNew','VehicleNew',3);" onkeydown="return on_keydown(event,'txtVehicleNew','lstVehicleNew');"
                                    onfocus="On_Focus('txtVehicleNew','lstVehicleNew'); txtbox_onfocus(this);" MaxLength="150"
                                    EnableViewState="False" Width="50%"></asp:TextBox>
                                <asp:ListBox ID="lstVehicleNew" Style="position: absolute; z-index: 1000" onfocus="listboxonfocus('txtVehicleNew')"
                                    TabIndex="5" runat="server"></asp:ListBox>
                                <asp:HiddenField ID="hdn_VehicleIdNew" Value="0" runat="server" />
                            </ContentTemplate>
                            <Triggers>
