<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmLandmark1.aspx.cs" Inherits="Master_Location_FrmLandmark1"
            ...
            <table class="TABLE" width="100%">
                <tr>
                    <td class="TDGRADIENT" colspan="3" style="height: 16px">
                        <asp:Label ID="lbl_Heading" CssClass="HEADINGLABEL" runat="server" Text="Landmark 1"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="TD1" style="width: 20%">
                        Delivery Area</td>
                    <td style="width: 79%">
                        <asp:DropDownList ID="ddlDeliveryArea" CssClass="DROPDOWN" runat="server" Width="50%" /></td>
                    <td class="TDMANDATORY" style="width: 1%">
                        *</td>
                ...
                <tr>
                    <td class="TD1" style="width: 20%">
                        Landmark&nbsp;</td>
                    <td style="width: 79%">
                        <asp:TextBox ID="txtLandmark1" runat="server" BorderWidth="1px" CssClass="TEXTBOX" Width="50%"
