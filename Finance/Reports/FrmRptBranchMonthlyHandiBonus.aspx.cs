...
public partial class Finance_Reports_FrmRptBranchMonthlyHandiBonus : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Wuc_Export_To_Excel1.FileName = "Handi Bonus Detailed";
    ...
    private void BindGrid(object sender, EventArgs e)
    {
        ...
        objDAL.RunProc("EC_Rpt_Branch_HandiBonus", objSqlParam, ref ds);
        ...
        ValidateReportForm(dg_Grid, ds.Tables[1], CallFrom,lbl_Error);
        ValidateReportForm(dg_GridMaster, ds.Tables[0], CallFrom, lbl_Error);
    ...
    protected void dg_GridMaster_RowCreatedMaster(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            GridView HeaderGrid = (GridView)sender;
            ...
            HeaderCell = new TableCell();
            HeaderCell.Text = "BonusPerLR";
            HeaderCell.Font.Bold = true;
            HeaderCell.HorizontalAlign = HorizontalAlign.Center;
            HeaderCell.BackColor = System.Drawing.Color.LightSkyBlue;
            HeaderGridRow.Cells.Add(HeaderCell);
            dg_GridMaster.Controls[0].Controls.AddAt(0, HeaderGridRow);
        }
    }
