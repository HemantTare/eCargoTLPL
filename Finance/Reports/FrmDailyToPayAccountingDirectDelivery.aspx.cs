...
public partial class Finance_Reports_FrmDailyToPayAccountingDirectDelivery : System.Web.UI.Page
{
    #region Declaration
    private DataSet ds;
    string Crypt;
    ...
    {
        tr_RegionAreaBranch.Attributes.Add("style", "display:none");
    ...
    private void BindGrid(object sender, EventArgs e)
    {
        ...
        SqlParameter[] objSqlParam ={  
            ...
            objDAL.MakeInParams("@FromDate", SqlDbType.DateTime,0,AsOnDate),
            objDAL.MakeInParams("@ToDate", SqlDbType.DateTime,0,AsOnDate),
            objDAL.MakeInParams("@PageIndex",SqlDbType.Int,0,grid_currentpageindex),
            objDAL.MakeInParams("@PageSize",SqlDbType.Int,0,grid_PageSize) 
        };

        objDAL.RunProc("EC_RPT_Daily_To_Pay_Accounting_Direct_Dly_GRD", objSqlParam, ref ds);
    ...
    protected void dg_GridToPay_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
    {
        ...
        if ((e.Item.Cells[0].Text).Length > 8)
        {
            if ((e.Item.Cells[0].Text).Substring(0, 7) == "Booking")
            {
                e.Item.BackColor = System.Drawing.Color.Yellow;
                e.Item.ForeColor = System.Drawing.Color.Black;
                e.Item.Font.Bold = true;
    ...
    protected void dg_GridDispatchToPay_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType== ListItemType.AlternatingItem) //== DataControlRowType.DataRow)            
        {
            ...
            if (Util.String2Int(hdn_Dest_Branch_ID.Value) > 0)
            {
