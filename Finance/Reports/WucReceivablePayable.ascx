<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WucReceivablePayable.ascx.cs" Inherits="Finance_Reports_WucReceivablePayable" %>
...
<asp:ScriptManager ID="SM_Ledger_Outstandings_Rec_Pay" runat="server"></asp:ScriptManager>
    ...
    <table  class="TABLE" style="width: 100%">
        <tr>
            <td colspan="7"  class="TDGRADIENT">
                 &nbsp;<asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="RECEIVABLE OUTSTANDING" Font-Bold="True" /></td>
        </tr>
        <tr> 
        <td colspan="7">
            &nbsp;</td>
        ...
        <td colspan="2" style="height: 5px" align="left">
         &nbsp;<asp:Button ID="btn_ShowBillWiseDetails" runat="server" CssClass="BUTTON" Font-Names="verdana"
                ...
                Text="AGEING LEDGER WISE" Width="200px" OnClick="btn_Ageing_Click"  />
            </td>
                </tr>
        <tr>
     ...
     <tr>
        <td colspan="6" style="height: 353px" >
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                <igtbl:UltraWebGrid ID="grid" runat="server" Height="100%" Width="100%"  OnInitializeRow="grid_InitializeRow" OnInitializeLayout="grid_InitializeLayout" EnableTheming="True" >
...
<%--                               <Pager AllowPaging="True" ChangeLinksColor="True" 
                                    Alignment="Left" MinimumPagesForDisplay="1" PageSize="15"  QuickPages="1">
...
<%--     <asp:Panel ID="pnl_Total" runat="server" Width="100%">
       ...
       <td class="TD1" style="width:50%;font-family:Verdana;font-size:small">Total Pending Amount :</td>  
        ...
        <td class="TD1" style="width:50%;font-family:Verdana;font-size:small">Total Pending Amount :</td>  
        <td  style="width:40%">
         &nbsp<asp:Label Id="Label1" runat="server" CssClass="LABEL" Font-Bold="true"  Text="TOTAL:" ></asp:Label>        
         </td>
         </asp:Panel>
