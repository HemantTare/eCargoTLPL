<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmFreight_TempoExp.aspx.cs"
    Inherits="Finance_Reports_FrmFreight_TempoExp" %>
...
<head runat="server">
    <title>Freight Vs Tempo Expense</title>
    <link href="../../CommonStyleSheet.css" rel="stylesheet" type="text/css" />
</head>
<body style="margin: 0px">
    <form id="form1" runat="server">
        <asp:ScriptManager ID="scm_Freight_TempoExp" runat="server">
        </asp:ScriptManager>
        <table runat="server" id="Table1" class="TABLE" onclick="rr()">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Freight Vs Tempo Expense"></asp:Label>
                </td>
            </tr>
        </table>
                        ...
                        <ContentTemplate>
                            <div class="DIV" style="height: 510px; width: 100%; "  >
                                <asp:DataGrid ID="dg_Grid" runat="server" ShowFooter="True"
                                    ...
                                    OnItemDataBound="dg_Grid_ItemDataBound"   Width ="60%">
                                    <AlternatingItemStyle CssClass="GRIDALTERNATEROWCSS" />
                                    <HeaderStyle CssClass="GRIDHEADERCSS" />
                                    <FooterStyle CssClass="GRIDFOOTERCSS" />
                                    <PagerStyle CssClass="GRIDPAGERCSS" Mode="NumericPages" />
                                    <Columns> 
                                        <asp:BoundColumn DataField="DlyBranch" HeaderText="Delivery Branch">
