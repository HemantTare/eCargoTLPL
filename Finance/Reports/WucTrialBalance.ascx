<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WucTrialBalance.ascx.cs" Inherits="Finance_Reports_WucTrialBalance" %>
...
<table  class="TABLE" style="width: 100%">
        <tr>
            <td colspan="7"  class="TDGRADIENT">
                 &nbsp;<asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="TRIAL BALANCE" Font-Bold="True" />
                </td>
        </tr>
        <tr>
        <td colspan="7"></td>
            ...
            <asp:DataGrid id="dgTrialBalance" runat="server" OnItemDataBound="dgTrialBalance_RowDataBound" AutoGenerateColumns="False" AllowSorting="True" CssClass="GRID" ShowFooter="True">
             ...
             <Columns>
                    <asp:TemplateColumn  FooterText="GRAND TOTAL">
                        ...
                        NavigateUrl='<%# "FrmGroupSummary.aspx?Menu_Item_Id=" + ClassLibraryMVP.Util.EncryptInteger(MenuItemId) + "&Mode=" + ClassLibraryMVP.Util.EncryptInteger(Mode) + "&IsConsolidated=" + Is_Consol + "&Hierarchy_Code=" + Hierarchy_Code + "&Main_Id=" + Main_Id +"&Id=" +ClassLibraryMVP.Util.EncryptInteger(Convert.ToInt32(DataBinder.Eval(Container.DataItem,"Id"))) +"&Category=" +ClassLibraryMVP.Util.EncryptInteger(Convert.ToInt32(DataBinder.Eval(Container.DataItem,"Category"))) +"&StartDate=" + ClassLibrary.UIControl.Util.EncryptString(Convert.ToString(StartDate)) + "&EndDate=" + ClassLibrary.UIControl.Util.EncryptString(Convert.ToString(EndDate)) + "&Group=" + Convert.ToString(DataBinder.Eval(Container.DataItem,"Name")) %>'
