<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmDailyToPayAccounting.aspx.cs"
    Inherits="Finance_Reports_FrmDailyToPayAccounting" %>
...
<head runat="server">
    <title>Daily ToPay Accounting</title>
        ...
        <table runat="server" id="Table1" class="TABLE" onclick="rr()">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Daily ToPay Accounting"></asp:Label>
                </td>
            </tr>
        </table>
                        ...
                        <ContentTemplate>
                            <div class="DIV" style="height: 510px; width: 100%;">
                                ...
                                <asp:Label ID="lblToPay" runat="server" Font-Bold="True" Visible="False" Font-Size="Large"
                                    Text="      Today's Dispatch (To Pay)      " BackColor="SlateGray" ForeColor="PowderBlue"
                                    Width="99%"></asp:Label>
