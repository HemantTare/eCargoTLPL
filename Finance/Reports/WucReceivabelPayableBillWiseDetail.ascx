<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WucReceivabelPayableBillWiseDetail.ascx.cs" Inherits="Finance_Reports_WucReceivabelPayableBillWiseDetail" %>
