<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmRptBranchMonthlyHandiBonusSummary.aspx.cs"
    Inherits="Finance_Reports_FrmRptBranchMonthlyHandiBonusSummary" %>
...
<head runat="server">
    <title>Branch Monthly Handi Bonus Summary</title>
        ...
        <table runat="server" id="Table1" class="TABLE" onclick="rr()">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Branch Monthly Handi Bonus Summary"></asp:Label>
                </td>
            </tr>
        </table>
