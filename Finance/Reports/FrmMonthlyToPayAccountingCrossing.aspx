<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmMonthlyToPayAccountingCrossing.aspx.cs"
    Inherits="Finance_Reports_FrmMonthlyToPayAccountingCrossing" %>
...
<head runat="server">
    <title>Monthly ToPay Accounting - Crossing</title>
        ...
        <table runat="server" id="Table1" class="TABLE" onclick="rr()">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Monthly ToPay Accounting - Crossing"></asp:Label>
                </td>
            </tr>
        </table>
        <table class="TABLE" id="tab_DailyToPayAccounting" runat="server">
            ...
            <tr>
                <td style="width: 10%; text-align: right; height: 15px;">
                    <asp:Label ID="lbl_Month" runat="server" Text="For Month :"></asp:Label></td>
                <td style="width: 10%; height: 15px;">
                    &nbsp;<asp:DropDownList ID="ddl_Month" runat="server">
                    </asp:DropDownList></td>
                <td style="width: 10%; height: 15px;" class="TD1">
                    Year</td>
                <td style="width: 10%; height: 15px;">
                        ...
                        <ContentTemplate>
                            <div class="DIV" style="height: 510px; width: 100%;">
                                ...
                                <asp:Label ID="lblToPay" runat="server" Font-Bold="True" Visible="False" Font-Size="Large"
                                    Text="      Total Dispatch (To Pay) - Crossing    " BackColor="SlateGray" ForeColor="PowderBlue"
                                    Width="99%"></asp:Label>
...
--%>
                                        <%--                                        <asp:TemplateColumn HeaderText="Direct" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                            <ItemTemplate>
                                        ...
                                        <asp:BoundColumn DataField="TotalToPay" HeaderText="Total ToPay">
                                            <ItemStyle HorizontalAlign="Right" />
