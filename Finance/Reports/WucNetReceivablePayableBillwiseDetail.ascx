<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WucNetReceivablePayableBillwiseDetail.ascx.cs" Inherits="Finance_Reports_WucNetReceivablePayableBillwiseDetail" %>
    ...
    <table  class="TABLE" style="width: 100%">
        <tr>
            <td colspan="7"  class="TDGRADIENT">
                 &nbsp;<asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="RECEIVABLE  BILLWISE DETAILS" Font-Bold="True" /></td>
        </tr>
        <tr>
        <td colspan="7"></td>
        </tr>
         ...
         &nbsp;<asp:Button ID="btn_ShowBillWiseDetails" runat="server" CssClass="BUTTON" Font-Names="verdana"
                Text="SHOW RECEIVABLE OUTSTANDING" Width="200px" OnClick="btn_ShowReceivableOutstanding_Click"/>
        ...
        <tr class="TD1" style="width: 80%">
            <td align="left" colspan="5" style="width: 50%; height: 5px">
            </td>
        </tr>
             <tr>
        <td colspan="7">
