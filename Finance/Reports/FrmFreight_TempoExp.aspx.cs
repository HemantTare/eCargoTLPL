...
public partial class Finance_Reports_FrmFreight_TempoExp : System.Web.UI.Page
{
    #region Declaration
    private DataSet ds;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Wuc_Export_To_Excel1.FileName = "FreightVsTempoExpense";
    ...
    private void BindGrid(object sender, EventArgs e)
    {
        ...
        objDAL.RunProc("EC_RPT_Freight_TempoExp_GRD", objSqlParam, ref ds); 
    ...
    private void PrepareDTForExportToExcel()
    {
        ...
        //dr1["Selection Criteria"] = "From Date: " + From_Date.ToString("dd-MMM-yyyy") + " - " + " To Date: " + To_date.ToString("dd-MMM-yyyy");
        //DTTemp.Rows.Add(dr1);
