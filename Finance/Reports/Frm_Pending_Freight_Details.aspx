<%@ Page AutoEventWireup="true" CodeFile="Frm_Pending_Freight_Details.aspx.cs" Inherits="Finance_Reports_Frm_Pending_Freight_Details"
    Language="C#" %>
...
<head runat="server">
    <title>Pending Freight Details</title>
        ...
        <table id="Table1" runat="server" class="TABLE">
            <tr>
                <td class="TDGRADIENT" style="width: 100%">
                    <asp:Label ID="lbl_Heading" runat="server" CssClass="HEADINGLABEL" Text="Pending Freight Details"></asp:Label>
                </td>
            </tr>
        </table>
