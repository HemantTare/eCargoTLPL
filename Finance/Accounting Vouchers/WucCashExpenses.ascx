<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WucCashExpenses.ascx.cs"
...
<table style="width: 100%;" class="TABLE">
    <tr>
        <td class="TDGRADIENT" colspan="6">
            <asp:Label ID="Label1" runat="server" Text="CASH EXPENSES" CssClass="HEADINGLABEL"></asp:Label>
        </td>
    </tr>
    <tr>
