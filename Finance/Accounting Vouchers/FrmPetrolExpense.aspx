<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmPetrolExpense.aspx.cs"
    Inherits="Finance_Accounting_Vouchers_FrmPetrolExpense" %>
...
function Allow_To_Save()
{
    ...
    {
        lblErrors.innerHTML = 'Enter Reason';
        txt_Reason.focus();
    }
            ...
            <table class="TABLE" style="width: 100%">
                <tr>
                    <td class="TDGRADIENT" style="width: 100%" colspan="4">
                        <asp:Label ID="lbl_Heading" CssClass="HEADINGLABEL" runat="server" Text="Petrol Expense"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 50%;" colspan="2">
                        <asp:TextBox ID="txt_VehicleNo" runat="server" CssClass="TEXTBOX" MaxLength="20"
