<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WucCashDepositeInBank.ascx.cs"
    Inherits="Finance_Accounting_Vouchers_CashDepositeInBank" %>
...
<table style="width: 100%;" class="TABLE">
    <tr>
        <td class="TDGRADIENT" colspan="6">
            <asp:Label ID="Label1" runat="server" Text="CASH DEPOSITED IN BANK" CssClass="HEADINGLABEL"></asp:Label>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="width: 20%; height: 24px;">
            <asp:TextBox ID="txt_RefNo" runat="server" CssClass="TEXTBOX" BorderWidth="1px" Style="width: auto;" MaxLength="25" onfocus="txtbox_onfocus(this)" onblur="txtbox_onlostfocus(this)"></asp:TextBox>
        </td>
    ...
    <tr>
        <td style="width: 10%; text-align: right">
            Deposited By :</td>
        <td style="width: 20%">
            <asp:TextBox ID="txt_PaidToWhom" runat="server" BorderWidth="1px" CssClass="TEXTBOX" Style="width: auto" MaxLength="100" onfocus="txtbox_onfocus(this)" onblur="txtbox_onlostfocus(this)"></asp:TextBox></td>
        <td style="width: 30%">
        </td>
        <td style="width: 20%">
        </td>
...
<table class="TABLENOBORDER" style="width: 100%;">
    <tr style="display: none">
        <td style="width: 100%">
            <asp:HiddenField ID="hdn_Default_Bank_Ledger_Name" runat="server" />
