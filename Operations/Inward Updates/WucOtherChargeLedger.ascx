<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WucOtherChargeLedger.ascx.cs" Inherits="Operations_Inward_Updates_WucOtherChargeLedger" %>
...
<table width="100%">    
     ...
     <tr>
        ...
        <asp:UpdatePanel ID="up_GridTotal" runat="server" UpdateMode="Always">
            <ContentTemplate>
                <asp:Label ID="lbl_Total" runat="server" CssClass="LABEL" Text="Total Other Charge Amount :" Font-Bold="true"></asp:Label>
