<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmGCConsigneeList.aspx.cs"
    Inherits="Operations_Inward_Updates_FrmGCConsigneeList" %>
...
<script language="javascript" type="text/javascript">
 ...
 function viewwindow_general(GC_ID,Consignee_Name,GC_No,BranchID)
    {
        var Path='../../Operations/Inward Updates/FrmGCConsigneeUpdate.aspx?GC_ID=' + GC_ID + '&Consignee_Name=' + Consignee_Name + '&GC_No=' + GC_No + '&BranchID=' + BranchID;
...
<head id="Head1" runat="server">
    <title>GC Consignee List</title>
    <link href="../../CommonStyleSheet.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <asp:ScriptManager ID="scm_GCConsigneeList" runat="server">
            </asp:ScriptManager>
            <table class="TABLE">
                <tr>
                    <td class="TDGRADIENT" colspan="3">
                        <asp:Label ID="lbl_heading" runat="server" CssClass="HEADINGLABEL" Text="Consignee List"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="width: 11%">
                ...
                <tr id="tr_DlyBranchGrid" runat="server">
                    <td colspan="3">
                        <asp:UpdatePanel ID="up_ConsigneeList" runat="server" UpdateMode="conditional">
                            <ContentTemplate>
                                <asp:DataGrid ID="dg_ConsigneeList" runat="server" AutoGenerateColumns="False" CssClass="GRID"
                                    OnItemDataBound="dg_GCConsigneeList_ItemDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="GC_ID" Visible="False">
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hdn_gc_To_Location_ID" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "To_Location_ID") %>' />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderText="Update">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnk_ConsigneeUpdate" runat="server" Text="Update"></asp:LinkButton>
                                            </ItemTemplate>
