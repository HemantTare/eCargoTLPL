<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WucGCRectification.ascx.cs" Inherits="Operations_Booking_WucGCRectification" %>
    ...
    <tr>
        ...
        <ContentTemplate>
            <asp:TextBox ID="txt_GC_No_For_Print" onblur="Validate_GCNo();" runat="server"
                onkeypress="return Only_Integers(this,event)" CssClass="TEXTBOXNOS" MaxLength="8"></asp:TextBox>
        </ContentTemplate>
            <Triggers>
            ...
            <td class="TD1" style="text-align: left;" colspan="4">
             <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                        ...
                        <asp:HiddenField ID="hdn_Is_Rectification_GC_Octroi_Updated" runat="server"></asp:HiddenField>
                        <asp:HiddenField ID="hdn_Is_Rectification_GC_Octroi_Applicable" runat="server"></asp:HiddenField>
                        <asp:HiddenField ID="hdn_Encrepted_Rectification_GC_Id" runat="server"></asp:HiddenField>
                </ContentTemplate>
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="btn_Go"></asp:AsyncPostBackTrigger>
                    <asp:AsyncPostBackTrigger ControlID="btn_ValidateGCNo"></asp:AsyncPostBackTrigger>                  
