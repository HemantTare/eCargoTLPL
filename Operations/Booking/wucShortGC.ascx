<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucShortGC.ascx.cs" Inherits="Operations_Booking_wucShortGC" %>
...
<script language="javascript" type="text/javascript" src="../../Javascript/Operations/Booking/ShortGC.js"></script>

<asp:ScriptManager ID="SM_ShortGC" runat="server"></asp:ScriptManager>
...
<script type="text/javascript">
    ...
    {    
        var hdn_ClientId = document.getElementById('wucShortGC1_hdn_ClientId');   
        var hdn_Is_Consignor = document.getElementById('wucShortGC1_hdn_Is_Consignor');   
    ...
    {    
        var hdn_LocationId = document.getElementById('wucShortGC1_hdn_LocationId');   
        var hdn_LocationName = document.getElementById('wucShortGC1_hdn_LocationName');   
        var hdn_Is_FromLocation = document.getElementById('wucShortGC1_hdn_Is_FromLocation');   
    ...
    {    
        var hdn_CommodityId = document.getElementById('wucShortGC1_hdn_CommodityId');   
        var hdn_CommodityName = document.getElementById('wucShortGC1_hdn_CommodityName');     
    ...
    {    
        var hdn_ItemId = document.getElementById('wucShortGC1_hdn_ItemId');   
        var hdn_ItemName = document.getElementById('wucShortGC1_hdn_ItemName');   
        var hdn_CommodityId = document.getElementById('wucShortGC1_hdn_CommodityId');   
    ...
    {        
        var hdn_GC_No_For_Print = document.getElementById('wucShortGC1_hdn_GC_No_For_Print');   
...
<table class="TABLE" style="width: 100%;">     
    ...
    <tr>
        ...
        <td style="width: 10%;">
            <asp:UpdatePanel ID="upd_GC_No_For_Print" runat="server">
                <contenttemplate>
                      <asp:DropDownList ID="ddl_GC_No" runat="server" Width="40%" CssClass="DROPDOWN"></asp:DropDownList>
                      <asp:Label ID="lbl_GC_No" CssClass="LABEL" runat="server" Font-Bold="true" Text="-"></asp:Label>
                      <asp:TextBox ID="txt_GC_No_For_Print" runat="server" onchange="Validate_GCNo();" Width="36%" 
                ...
                <triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="btn_Save_Repeat"></asp:AsyncPostBackTrigger>
                </triggers>
            </asp:UpdatePanel>
        </td>
        ...
        <td style="width: 10%;">            
            <asp:UpdatePanel ID="upd_ddl_ConsignmentType" runat="server">
                <contenttemplate>
    ...
    <tr id="tr_lnk_Get_Next_No" runat="server">
        <td class="TD1" style="width: 10%">
        </td>
        <td style="width: 10%;">
        ...
        <td colspan="8" style="width: 62%;"></td>        
    </tr>
    ...
    <tr id="tr_OpeningGC" runat="server">
        ...
        <td style="width: 10%;">
            <asp:UpdatePanel ID="upd_BookingBranch" runat="server">
                <contenttemplate>                
                    <cc1:DDLSearch ID="ddl_BookingBranch" runat="server" CallBackAfter="2" Text="" AllowNewText="True"
                        CallBackFunction="Raj.EF.CallBackFunction.CallBack.GetBranch" IsCallBack="True"
                        InjectJSFunction="On_FreightBasis_Change();" PostBack="True" OnTxtChange="ddl_BookingBranch_TxtChange">
                    </cc1:DDLSearch>                         
        ...
        <td style="width: 10%;">
            <asp:UpdatePanel ID="upd_ArrivedFromBranch" runat="server">
                <contenttemplate>                
                    <cc1:DDLSearch ID="ddl_ArrivedFromBranch" runat="server" CallBackAfter="2" Text="" AllowNewText="True"
                        CallBackFunction="Raj.EF.CallBackFunction.CallBack.GetBranch" IsCallBack="True"
                        PostBack="True" OnTxtChange="ddl_ArrivedFromBranch_TxtChange">
                    </cc1:DDLSearch>                         
        ...
        <td style="width: 10%;"> 
                 <table border="0" cellpadding="0">
                 <tr>
                     <td onmouseup="Button_OnMouseUp(<%= Calendar1.ClientObjectId %>)" style="height: 24px" >
                        <ComponentArt:Calendar ID="wuc_ArrivedDate" runat="server" MinDate="1900-01-01" Width="95%"
                             CellPadding="2" AllowDaySelection="True" AllowMonthSelection="True" 
                             ClientSideOnSelectionChanged="Picker_OnSelectionChanged"
                             ControlType="Picker" PickerCssClass="PICKER" 
                             PickerCustomFormat="MMMM d yyyy" PickerFormat="Custom"> 
                        </ComponentArt:Calendar><%--AutoPostBackOnSelectionChanged="True" OnSelectionChanged="wuc_ArrivedDate_SelectionChanged" by shiv --%>
                     </td>
                     <td style="height: 24px" runat="server" id="TD19">
                         <img alt="" class="calendar_button" height="22" onclick="Button_OnClick(this, <%= Calendar1.ClientObjectId %>)"
                         onmouseup="Button_OnMouseUp(<%= Calendar1.ClientObjectId %>)" src="../../images/btn_calendar.gif"
                         width="25" />
                     </td>
                 </tr>
              </table>      
        ...
        <td  style="width: 29%">
            <ComponentArt:Calendar runat="server" id="Calendar1" AllowMultipleSelection="False"
                ...
                // Associate the picker and the calendar:
                    ...
                    {
                      if (window.<%= Calendar1.ClientObjectId %>_loaded && window.<%= wuc_ArrivedDate.ClientObjectId %>_loaded)
                      {
                        window.<%= Calendar1.ClientObjectId %>.AssociatedPicker = <%= wuc_ArrivedDate.ClientObjectId %>;
                        window.<%= wuc_ArrivedDate.ClientObjectId %>.AssociatedCalendar = <%= Calendar1.ClientObjectId %>;
                      }
                      else
                      {
    ...
    <tr id="tr_BookingType" runat="server">
        <td class="TD1" style="width: 10%">
        ...
        <td style="width: 10%;">
            <asp:DropDownList ID="ddl_BookingType" runat="server" AutoPostBack="false" onchange="On_BookingType_Change();"
                CssClass="DROPDOWN" Width="95%" OnSelectedIndexChanged="ddl_BookingType_SelectedIndexChanged">
            </asp:DropDownList>
        </td>
        <td class="TDMANDATORY" style="width: 1%">
            <asp:Label ID="lbl_mandatory_BookingType" runat="server" Text="*"></asp:Label>
        </td>
        <td class="TD1" style="width: 10%;">
        ...
        <td style="width: 10%;">
            <asp:DropDownList ID="ddl_DeliveryType" runat="server" onchange="On_DeliveryType_Change();"
                CssClass="DROPDOWN" Width="95%">
            </asp:DropDownList>
        </td>
        <td class="TDMANDATORY" style="width: 1%">
            <asp:Label ID="lbl_mandatory_DeliveryType" runat="server" Text="*"></asp:Label>
        </td>
        <td class="TD1" style="width: 10%">
        ...
        <td style="width: 10%;">
            <asp:UpdatePanel ID="upd_lbl_ExpectedDeliveryDateVaule" runat="server">
                <contenttemplate>
                    <asp:Label runat="server" Text="Exp Dly Date :" CssClass="LABEL" ID="lbl_ExpectedDeliveryDateVaule"
        ...
        <td style="width: 10%">
            <asp:DropDownList ID="ddl_PickupType" runat="server" CssClass="DROPDOWN" Width="95%"/>
        </td>
    </tr>
    <tr id="tr_ContainerDetails" runat="server">
        ...
        <td style="width: 10%;">
            <asp:LinkButton ID="lnk_ContainerDetails" runat="server" Text="Container Details"
                TabIndex="9999" OnClientClick="return ContainerDetails();">
            </asp:LinkButton>
        </td>
        <td class="TDMANDATORY" style="width: 1%"></td>
        <td class="TD1" colspan="8" style="width: 62%;"></td>       
    </tr>
    <tr id="tr_LocationDetails" runat="server">
        ...
        <td style="width: 10%;">
            <asp:UpdatePanel ID="upd_FromLocation" runat="server">
                <contenttemplate>
                    <cc1:DDLSearch ID="ddl_FromLocation" runat="server" CallBackAfter="2" Text="" AllowNewText="True"
                        CallBackFunction="Raj.EF.CallBackFunction.CallBack.GetSearchLocation" IsCallBack="True"
                        InjectJSFunction="On_FreightBasis_Change();"  PostBack="True"
                        onchange="On_FreightBasis_Change();On_PaymentType_Change();" OnTxtChange="ddl_FromLocation_TxtChange">
                    </cc1:DDLSearch>                        
                ...
                <triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="dg_CommodityNandwana"></asp:AsyncPostBackTrigger>                    
                    <asp:AsyncPostBackTrigger ControlID="ddl_BookingBranch"></asp:AsyncPostBackTrigger>                     
                </triggers>
            </asp:UpdatePanel>
        </td>
        ...
        <td style="width: 10%;">
            <asp:UpdatePanel ID="upd_ToLocation" runat="server">
                <contenttemplate>                
                    <cc1:DDLSearch ID="ddl_ToLocation"  runat="server" Text="" onchange="On_FreightBasis_Change();On_PaymentType_Change();"
                        OnTxtChange="ddl_ToLocation_TxtChange" PostBack="True" InjectJSFunction="On_FreightBasis_Change();"
        ...
        <td class="TD1" style="width: 10%;">             
             <a id="lnk_Require_Forms"  href="javascript:Require_Forms();" >                
                <asp:Label ID="lbl_Require_Forms" CssClass="LABEL" Text="Require Form :" runat="server"></asp:Label>                
             </a>         
        </td>
        <td style="width: 10%">
            <asp:UpdatePanel ID="upd_chk_IsOctroiApplicable" runat="server">
                <contenttemplate>
                    <asp:CheckBox ID="chk_IsOctroiApplicable"  runat="server" Enabled="False">
                    </asp:CheckBox>
    ...
    <tr id="tr_AddLocation" runat="server">
        ...
        <td class="TDMANDATORY" style="width: 1%;"></td>
        <td style="width: 45%;" colspan="5"></td>       
    </tr>       
</table>
<table class="TABLE" style="width: 100%;">
    <tr id="tr_ConsignorConsigneeDetails" runat="server">
        <td class="TD1" style="width: 36%; vertical-align: top">
                        ...
                        <table style="width: 100%">                              
                                <tr>
                                    ...
                                    <td style="width: 89%" align="left">
                                        <cc1:DDLSearch ID="ddl_Consignor"  runat="server" onchange="On_FreightBasis_Change();On_PaymentType_Change();"
                                ...
                                <tr id="tr_Consignor_Details" runat="server">
                                    ...
                                    <td style="width: 89%" align="left">
                                    <div id="div_ConsignorDetailsValue" class="DIV" style="width:100%; height: 70px; text-align:left;border:1">
                                ...
                                <tr id = "tr_ConsignorTINNo" runat="server" >
                                    ...
                                    <td style="width: 89%" align="left">
                                        <asp:TextBox ID="txt_ConsignorTINNo" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="50" 
                                        BorderWidth="1px" Width="95%" ReadOnly="True"></asp:TextBox>
                                    </td>
                                </tr>                                
                                 <tr>
                                    ...
                                    <tr>
                                     <td style="width: 100%" class="TD1">
                                        <asp:LinkButton ID="lnk_NewConsignor" runat="server" Text="New" TabIndex="9999" 
                                                OnClientClick="return New_Consignor_Consignee(0,1);"></asp:LinkButton>&nbsp;
                                        <asp:LinkButton ID="lnk_EditConsignor" runat="server" Text="Edit" TabIndex="9999" 
                                        OnClientClick="return New_Consignor_Consignee(1,1);"></asp:LinkButton>&nbsp;                                            
                                        <asp:LinkButton ID="lnk_ViewConsignor"  runat="server" AutoPostBack="false" TabIndex="9999" 
                                        Text="View" OnClientClick="return View_Consignor_Consignee(1,1);"></asp:LinkButton>&nbsp;
                                    </td>
                                    </tr>
                                    </table>
                                    </td>
                                 ...
                                 <tr id="tr_Hidden_Consignor_Details" runat="server">
                                    <td style="width: 100%" align="left" colspan="2">
                                        ...
                                        <asp:HiddenField ID="hdn_IsServiceTaxApplicableForConsignor" runat="server" Value="0"></asp:HiddenField>
                    ...
                    <contenttemplate>
                        <table style="width: 100%; vertical-align: top">                              
                                ...
                                <tr id="tr_Consignee_Details" runat="server">
                                    ...
                                    <td style="width: 89%" align="left">
                                    <div id="div_ConsigneeDetails" class="DIV" style=" width:100%; height: 70px; text-align:left">
                                ...
                                <tr  id = "tr_ConsigneeTINNo" runat="server" >
                                    ...
                                    <td style="width: 89%" align="left">
                                        <asp:TextBox ID="txt_ConsigneeTINNo" runat="server" meta:resourcekey="txt_ConsigneeTINNoResource1"
                                            CssClass="TEXTBOXASLABEL" MaxLength="50" BorderWidth="1px" Width="95%" ReadOnly="True"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 100%" align="left" colspan="2">                                    
                                            ...
                                            <td style="width: 60%"  class="TD1"  >
                                                <asp:Panel ID="pnl_Change_Consignee_Address" runat="server" BorderWidth="0px" Width="100%" >
                                                    <asp:LinkButton ID="lnk_Change_Door_Delivery_Address"  runat="server" TabIndex="9999" 
                                                        Text="Door Delivery Address." OnClientClick="return Change_Consignee_Address();"></asp:LinkButton>                                                
                                                </asp:Panel>
                                            </td>
                                            <td style="width: 35%"  class="TD1" >
                                                <asp:Panel ID="pnl_EditConsignee" runat="server" meta:resourcekey="pnl_Change_Consignee_AddressResource1"
                                                    BorderWidth="0px" Width="100%" align="right">                                            
                                                        <asp:LinkButton ID="lnk_NewConsignee"  runat="server" Text="New"  TabIndex="9999" 
                                                        OnClientClick="return New_Consignor_Consignee(0,0);"></asp:LinkButton>&nbsp;            
                                                        <asp:LinkButton ID="lnk_EditConsignee"  runat="server"  TabIndex="9999" 
                                                            Text="Edit" OnClientClick="return New_Consignor_Consignee(1,0);"></asp:LinkButton>&nbsp;                                                                
                                                        <asp:LinkButton ID="lnk_ViewConsignee"  runat="server"  TabIndex="9999" 
                                                            Text="View" OnClientClick="return View_Consignor_Consignee(1,0);"></asp:LinkButton>                                                    
                                                </asp:Panel>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <tr id="tr_Hidden_Consignee_Details" runat="server">                                 
                                    <td style="width: 100%" align="left" colspan="2">
                                        ...
                                        <asp:HiddenField ID="hdn_IsServiceTaxApplicableForConsignee" runat="server" Value="0"></asp:HiddenField>
        ...
        <td class="TD1" style="width: 29%; vertical-align: top;">
            <table class="TABLE" style="width: 100%">
                <tr>
                    <td class="TD1" style="width: 40%">
                        <asp:Label ID="lbl_PaymentType" CssClass="LABEL" Text="Payment Type :" runat="server"></asp:Label>
                    </td>
                ...
                <tr id="tr_Contractual_Client_Details" runat="server">
                    ...
                    <td style="width: 59%" align="left">
                        <asp:UpdatePanel ID="upd_ddl_ContractualClient" runat="server">
                            <contenttemplate>
                                <cc1:DDLSearch ID="ddl_ContractualClient"  runat="server" OnTxtChange="ddl_ContractualClient_TxtChange" 
                                    PostBack="True" IsCallBack="True" CallBackFunction="Raj.EF.CallBackFunction.CallBack.GetSearchContractualClient"
                                    AllowNewText="True" CallBackAfter="2"></cc1:DDLSearch>
                ...
                <tr id="tr_Contract_Branch_Details" runat="server">
                    ...
                    <td style="width: 59%" align="left">                 
                        <asp:UpdatePanel ID="upd_ddl_ContractBranch" runat="server">
                            <contenttemplate>
                                <asp:DropDownList ID="ddl_ContractBranch" runat="server" CssClass="DROPDOWN" Width="95%" 
                                OnSelectedIndexChanged="ddl_ContractBranch_SelectedIndexChanged" AutoPostBack="True">
                                </asp:DropDownList>
                                <asp:HiddenField ID="hdn_ContractBranchId" runat="server"></asp:HiddenField>
                            </contenttemplate>
                            <triggers>
                                <asp:AsyncPostBackTrigger ControlID="ddl_PaymentType"></asp:AsyncPostBackTrigger>
                                <asp:AsyncPostBackTrigger ControlID="ddl_BillingBranch"></asp:AsyncPostBackTrigger>
                ...
                <tr id="tr_Contract_Details" runat="server">
                    ...
                    <td style="width: 59%" align="left">
                        <asp:UpdatePanel ID="upd_ddl_Contract" runat="server">
                            <contenttemplate>
                                <asp:DropDownList ID="ddl_Contract" runat="server" CssClass="DROPDOWN" Width="95%" 
    ...
    <tr id="tr_billing_details" runat="server" >
        ...
        <td  id="td_ddl_Billing_Party" runat="server"    style="width: 10%;">
            <asp:UpdatePanel ID="upd_ddl_BillingParty" runat="server">
                <contenttemplate>
                    <cc1:DDLSearch ID="ddl_BillingParty" runat="server" OnTxtChange="ddl_BillingParty_TxtChange" 
                    PostBack="True" IsCallBack="True" CallBackFunction="Raj.EF.CallBackFunction.CallBack.GetSearchBillingParty"
                    AllowNewText="True" CallBackAfter="2"></cc1:DDLSearch>
        ...
        <td  id="td_lbl_Billing_Branch" runat="server" class="TD1" style="width: 10%;">
        <asp:Label ID="lbl_BillingBranch" CssClass="LABEL" Text="Billing Branch :" runat="server"
                            meta:resourcekey="lbl_BillingBranchResource1"></asp:Label>
        </td>
        
        <td  id="td_ddl_Billing_Branch" runat="server"  style="width: 10%">
            <asp:UpdatePanel ID="upd_ddl_BillingBranch" runat="server">
            <contenttemplate>
                <cc1:DDLSearch ID="ddl_BillingBranch"  runat="server" OnTxtChange="ddl_BillingBranch_TxtChange" 
                PostBack="True" IsCallBack="True" CallBackFunction="Raj.EF.CallBackFunction.CallBack.GetBranch"
                AllowNewText="True" CallBackAfter="2"></cc1:DDLSearch>
        ...
        <td class="TD1" style="width: 15%" colspan="2">        
             <asp:TextBox ID="txt_BillingRemark" runat="server" Width="97%" CssClass="TEXTBOX" TextMode="MultiLine"
    ...
    <tr id="tr_UnitofMeasurmentDetails" runat="server">
        <td colspan="6" class="TD1" style=" vertical-align: top">
           <table class="TABLE" style=" vertical-align: top;">
                <tr  id="tr_tbl_Unitofmeasurement"  runat ="server" >
                ...
                <contenttemplate>
                    <table style="width: 100%" border="0" class="TABLE">                       
                            <tr  id="tr_UnitOfMeasurment" runat ="server" >
                                <td style="width: 10%" class="TD1">
                                ...
                                <td style="width: 10%">
                                    <asp:DropDownList ID="ddl_UnitOfMeasurment" runat="server" CssClass="DROPDOWN" Width="99%" 
                                        onchange="ddl_UnitOfMeasurment_Change()"></asp:DropDownList>
                                </td>
                            ...
                            <tr  id="tr_ConversionInFeet" runat ="server" >
                                ...
                                <td style="width: 10%">
                                    <asp:TextBox ID="txt_LengthInFeet" runat="server" CssClass="TEXTBOXNOSASLABEL" MaxLength="7" 
                                ...
                                <td style="width: 10%">
                                    <asp:TextBox ID="txt_WidthInFeet" runat="server" CssClass="TEXTBOXNOSASLABEL" MaxLength="7" 
                                    Width="95%" ReadOnly="True"></asp:TextBox>
                                ...
                                <td style="width: 10%">
                                    <asp:TextBox ID="txt_HeightInFeet" runat="server" CssClass="TEXTBOXNOSASLABEL" MaxLength="7" 
                                    Width="95%" ReadOnly="True"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td style="width: 12%;">
                        <asp:UpdatePanel ID="upd_ddl_GCRisk" runat="server">
                            <contenttemplate>
                                <asp:DropDownList ID="ddl_GCRisk" Width="95%" runat="server" onchange="ddl_GCRisk_Change()" CssClass="DROPDOWN"></asp:DropDownList>                    
                            </contenttemplate>
                            <triggers>
                                <asp:AsyncPostBackTrigger ControlID="ddl_PaymentType"></asp:AsyncPostBackTrigger>
                                <asp:AsyncPostBackTrigger ControlID="ddl_Contract"></asp:AsyncPostBackTrigger>
        ...
        <tr id="tr_dg_CommodityGeneral" runat="server">
            <td class="TD1" width="100%">
                    ...
                    <td>
                        <asp:UpdatePanel ID="upd_dg_Commodity" runat="server">
                            <contenttemplate>            
                                ...
                                <tr>
                                   <td colspan="12"  align="left" style="width: 90%">            
                                    <div id="Div_Commodity" class="DIV" style=" width:99%; height: 90px; text-align:left ">
                                        <table width="95%" align="left"  border="0">
                                        <tr>
                                            <td align="left" colspan="8">
                                                <asp:DataGrid ID="dg_Commodity" runat="server" CssClass="Grid" Width="580" 
                                                    OnCancelCommand="dg_Commodity_CancelCommand" OnUpdateCommand="dg_Commodity_UpdateCommand"
                                                    OnSortCommand="dg_Commodity_SortCommand" OnEditCommand="dg_Commodity_EditCommand"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateColumn HeaderText="Sr No" Visible="False">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" Text='<%# Eval("Sr_No") %>' CssClass="LABEL" ID="lbl_Commodity_SrNo"></asp:Label>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="Packing Type" >
                                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                            <FooterTemplate>
                                                                <asp:DropDownList runat="server" Width="100" DataValueField="Packing_Id" ID="ddl_Packing_Type"
                                                                     CssClass="DROPDOWN" DataTextField="Packing_Type">
                                                                </asp:DropDownList>
                                                            </FooterTemplate>
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" Text='<%# (DataBinder.Eval(Container.DataItem, "Packing_Type")) %>'
                                                                    CssClass="LABEL" ID="lbl_Packing_Type"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle Width="10%" HorizontalAlign="Center"></HeaderStyle>
                                                            <EditItemTemplate>
                                                                <asp:DropDownList runat="server" Width="100" DataValueField="Packing_Id" ID="ddl_Packing_Type"
                                                        ...
                                                        <asp:TemplateColumn HeaderText="Commodity_Id" Visible="False">
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" Text='<%# Eval("Commodity_Name") %>' CssClass="LABEL" ID="lbl_Commodity_Id"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="Articles">
                                                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                            <FooterTemplate>
                                                                <asp:TextBox runat="server" Width="90%" CssClass="TEXTBOXNOS" ID="txt_Articles"
                                                                    onkeyPress="return Only_Integers(this,event);" MaxLength="7"></asp:TextBox>
                                                            </FooterTemplate>
                                                            <ItemTemplate>
                                                            ...
                                                            <HeaderStyle Width="10%" HorizontalAlign="Center"></HeaderStyle>
                                                            <EditItemTemplate>
                                                                <asp:TextBox runat="server" Width="90%" CssClass="TEXTBOXNOS" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "Articles")) %>'
                                                        ...
                                                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                            <FooterTemplate>
                                                                <asp:TextBox runat="server" Width="80%" CssClass="TEXTBOXNOS" ID="txt_Weight"
                                                            ...
                                                            <HeaderStyle Width="10%" HorizontalAlign="Center"></HeaderStyle>
                                                            <EditItemTemplate>
                                                                <asp:TextBox runat="server" Width="80%" CssClass="TEXTBOXNOS" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "Weight")) %>'
                                                        ...
                                                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                            <FooterTemplate>
                                                                <asp:TextBox runat="server" Width="80%" CssClass="TEXTBOXNOS" ID="txt_Length"
                                                                    onkeyPress="return Only_Numbers(this,event);" MaxLength="7"></asp:TextBox>
                                                            </FooterTemplate>
                                                            <ItemTemplate>
                                                            ...
                                                            <HeaderStyle Width="10%" HorizontalAlign="Center"></HeaderStyle>
                                                            <EditItemTemplate>
                                                                <asp:TextBox runat="server" Width="80%" CssClass="TEXTBOXNOS" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "Length")) %>'
                                                                    ID="txt_length" MaxLength="7" onkeyPress="return Only_Numbers(this,event);"></asp:TextBox>
                                                            </EditItemTemplate>
                                                        </asp:TemplateColumn>                                                        
                                                         <asp:TemplateColumn HeaderText="Width">
                                                            <FooterTemplate>
                                                                <asp:TextBox runat="server" Width="80%" CssClass="TEXTBOXNOS" ID="txt_Width"
                                                                    onkeyPress="return Only_Numbers(this,event);" MaxLength="7"></asp:TextBox>
                                                            </FooterTemplate>
                                                            <ItemTemplate>
                                                            ...
                                                            <HeaderStyle Width="10%" HorizontalAlign="Center"></HeaderStyle>
                                                            <EditItemTemplate>
                                                                <asp:TextBox runat="server" Width="80%" CssClass="TEXTBOXNOS" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "Width")) %>'
                                                        ...
                                                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                            <FooterTemplate>
                                                                <asp:TextBox runat="server" Width="80%" CssClass="TEXTBOXNOS" ID="txt_Height"
                                                                   onkeyPress="return Only_Numbers(this,event);" MaxLength="7"></asp:TextBox>
                                                            </FooterTemplate>
                                                            <ItemTemplate>
                                                            ...
                                                            <HeaderStyle Width="10%" HorizontalAlign="Center"></HeaderStyle>
                                                            <EditItemTemplate>
                                                                <asp:TextBox runat="server" Width="80%" CssClass="TEXTBOXNOS" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "Height")) %>'
                                                        ...
                                                        <asp:TemplateColumn HeaderText="Remark">
                                                            ...
                                                            <ItemTemplate>                                                                    
                                                                <asp:TextBox ID="txt_Remark" runat="server" Width="80%" CssClass="TEXTBOXASLABEL" 
                                                                     Text='<%# (DataBinder.Eval(Container.DataItem, "Remark")) %>' onkeyPress=" return Check_Max_Length_For_Multiline(this,100);" 
                                                        ...
                                                        <asp:EditCommandColumn HeaderText="Edit" CancelText="Cancel" UpdateText="Update"
                                                            ValidationGroup="Btn_Save_Commodity" EditText="Edit">
                                                            <HeaderStyle Width="5%"></HeaderStyle>
                                                        </asp:EditCommandColumn>
                                                        <asp:TemplateColumn HeaderText="Delete">
                                                            <FooterTemplate>
                                                                <asp:LinkButton runat="server" ID="lbtn_Add_Commodity" Text="Add" CommandName="Add"
                                                                    ValidationGroup="Btn_Save_Commodity"></asp:LinkButton>
                                                            </FooterTemplate>
                                                            <ItemTemplate>
            ...
            <tr>
                <td style="width: 100%" align="left">
                   <asp:UpdatePanel ID="upd_CommodityTotal" runat="server">
                    <contenttemplate>
                    <table width="100%" border="0">
                    <tr>
            ...
            <tr id="tr_dg_CommodityNandwana" runat="server">
            <td class="TD1" width="100%">            
                <table class="TABLE" style="width: 100%; height: 10">
                    ...
                    <td>
                        <asp:UpdatePanel ID="upd_dg_CommodityNandwana" runat="server">
                            <contenttemplate>            
                                ...
                                <tr>
                                   <td colspan="12"  align="left"   style="width: 90%">            
                                    <div id="Div1" class="DIV" style=" width:99%; height: 90px; text-align:left ">
                                        <table width="95%" align="left"  border="0">
                                        <tr>
                                            <td align="left" colspan="8">
                                                <asp:DataGrid ID="dg_CommodityNandwana"  runat="server" meta:resourcekey="dg_CommodityResource1"
                                                    CssClass="Grid" Width="580" OnCancelCommand="dg_Commodity_CancelCommand" OnUpdateCommand="dg_Commodity_UpdateCommand"
                                                    OnSortCommand="dg_Commodity_SortCommand" OnEditCommand="dg_Commodity_EditCommand"
                                                    OnItemCommand="dg_Commodity_ItemCommand" OnItemDataBound="dg_Commodity_ItemDataBound"
                                                    OnDeleteCommand="dg_Commodity_DeleteCommand" AutoGenerateColumns="False" ShowFooter="True"
                                                    PageSize="5" CellPadding="3" AllowSorting="True" DataKeyField="Sr_No">
            ...
            <tr>
                <td style="width: 100%" align="left">
                   <asp:UpdatePanel ID="upd_CommodityNandwanaTotal" runat="server">
                    <contenttemplate>
                    <table width="100%" border="0">
                    <tr>
                        <td style="width: 20%" class="TD1">                                    
                        ...
                        <td style="width: 20%">        
                            <asp:Label Style="text-align: right" ID="lbl_CommodityTotalNandwana" runat="server" meta:resourcekey="lbl_Commodity_TotalResource1"
                                CssClass="LABEL" Text="Total :" Width="98%" Font-Bold="True"></asp:Label>                                    
                            </td>
                            <td style="width: 15%" class="TD1">
                ...
                <tr>
                    <td align="left">
                        <asp:UpdatePanel ID="upd_errorNandwana" runat="server">
                            <contenttemplate>
            ...
            <tr>
                        ...
                        <contenttemplate>
                            ...
                            <tr>
                                ...
                                <td align="left" style="width: 10%">
                                    <asp:DropDownList ID="ddl_FreightBasis" runat="server" CssClass="DROPDOWN" Width="90%" onchange="ddl_FreightBasis_Change();  ">
                                    </asp:DropDownList>
                                </td>
                                    <td style="width: 1%" class="TDMANDATORY"></td>
                                <td style="width: 10%">
                                  <asp:Label ID="lbl_ChargeWt" runat="server" meta:resourcekey="lbl_ChargeWtResource1"
                                        CssClass="LABEL" Text="Charge Wt.:"></asp:Label>
                                </td>                              
                                <td style="width: 10%" class="TD1">
                                   <asp:TextBox ID="txt_ChargeWeight" onkeypress="return Only_Numbers(this,event);" runat="server"
                                  ...
                                  <td style="width: 1%" class="TDMANDATORY">
                                    <asp:TextBox ID="txt_ActualWeight" onkeypress="return Only_Numbers(this,event);" runat="server"
                                        CssClass="TEXTBOXNOS" MaxLength="7" Width="1%" onchange=" On_Actual_Weight_Change();"></asp:TextBox>                                        
                                </td>
                                <td style="width: 10%">
                            ...
                            <tr id="tr_Volumetric" runat="server">
                                ...
                                <td id="Td5" style="width: 10%" runat="server">
                                    <asp:TextBox ID="txt_TotalCFT" runat="server" CssClass="TEXTBOXNOSASLABEL" MaxLength="10" 
                                        Width="95%" ReadOnly="True"></asp:TextBox>
                                ...
                                <td id="Td8" style="width: 10%" runat="server">
                                    <asp:TextBox ID="txt_TotalCBM" runat="server" CssClass="TEXTBOXNOSASLABEL" MaxLength="10" 
                                        Width="95%" ReadOnly="True"></asp:TextBox>
                            ...
                            <tr id="tr_VolumetrickgFactor" runat="server">
                                ...
                                <td id="Td12" colspan="7" style="width: 43%" runat="server"></td>
                            </tr>
                            </table>
                        </contenttemplate>
                        <triggers>
                        ...
                        <asp:UpdatePanel ID="upd_dg_Invoice" runat="server">
                            <contenttemplate>
                                <table class="TABLE" width="100%">
                                        <tr>
                                            <td align="left" width="100%">
                                                <div id="Div_Invoice" runat="server" class="DIV"  style=" width:98%; height: 90px;  text-align:left ">
                                                    <table width="95%">
                                                            <tr>
                                                                <td align="left" colspan="12">
                                                                    <asp:DataGrid ID="dg_Invoice"  runat="server" CssClass="Grid" Width="100%" OnCancelCommand="dg_Invoice_CancelCommand" 
                                                                        OnUpdateCommand="dg_Invoice_UpdateCommand" OnEditCommand="dg_Invoice_EditCommand"
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateColumn HeaderText="Sr No" Visible="False">
                                                                                <FooterTemplate>
                                                                                    <asp:TextBox runat="server" Width="30px" Enabled="False" CssClass="TEXTBOX"
                                                                                        ID="txt_Invoice_SrNo"></asp:TextBox>
                                                                                </FooterTemplate>
                                                                                <ItemTemplate>
                                                                                    <asp:Label runat="server" Text='<%# Eval("Sr_No") %>' CssClass="LABEL" ID="lbl_Invoice_SrNo"></asp:Label>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle Width="2%"></HeaderStyle>
                                                                                <EditItemTemplate>
                                                                                    <asp:TextBox runat="server" Width="30px" Enabled="False" CssClass="TEXTBOX"
                                                                            ...
                                                                            <asp:TemplateColumn HeaderText="BE / BL No.">
                                                                                ...
                                                                                <HeaderStyle Width="10%" HorizontalAlign="Center"></HeaderStyle>
                                                                                <EditItemTemplate>
                                                                                    <asp:TextBox runat="server" Width="98%" CssClass="TEXTBOX" Text='<%# DataBinder.Eval(Container.DataItem, "BE_BL_No") %>'
                                                                                        ID="txt_BE_BL_No" MaxLength="10" onkeyPress="return Only_Numbers(this,event);"></asp:TextBox>
                                                                                </EditItemTemplate>
                                                                            </asp:TemplateColumn>
                                                                            <asp:EditCommandColumn HeaderText="Edit" CancelText="Cancel" UpdateText="Update"
                                                                                ValidationGroup="Btn_Save_Invoice" EditText="Edit">
                                                                                <HeaderStyle Width="5%"></HeaderStyle>
                                                                            </asp:EditCommandColumn>
                                                                            <asp:TemplateColumn HeaderText="Delete">
                                                                                <FooterTemplate>
                                                                                    <asp:LinkButton runat="server" ID="lbtn_Add_Invoice" Text="Add" CommandName="Add"
                                                                                        ValidationGroup="Btn_Save_Invoice"></asp:LinkButton>
                                                                                </FooterTemplate>
                                                                                <ItemTemplate>
                                            ...
                                            <td align="left">
                                                <table width="100%" >
                                                        <tr>
                                                            ...
                                                            <td class="TD1" style="width: 10%"></td>
                                                            <td colspan="8" align="left" style="width: 80%"></td>
                                                            <td class="TDMANDATORY" style="width: 1%"></td>
                                                        </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td align="left">
                                                <asp:Label ID="lbl_InvoiceGridErrors" runat="server" CssClass="LABELERROR"></asp:Label>
                                            </td>
                                        </tr>
                                </table>
                            </contenttemplate>
                ...
                <tr>
                    <td class="TD1" width="100%">
                        <asp:UpdatePanel ID="upd_tbl_OtherDetails" runat="server">
                            <contenttemplate>
                        <table class="TABLE">
                            <tr>
                                <td class="TD1" style="width: 10%">
                                ...
                                <td colspan="8" align="left" style="width: 80%">
                                    <asp:TextBox ID="txt_OtherChargesRemark" runat="server" Width="99%" CssClass="TEXTBOX"></asp:TextBox>
                                </td>
                                <td class="TDMANDATORY" style="width: 1%"></td>
                            </tr>                            
                            <tr id="tr_Instruction" runat="server" >
                                <td class="TD1" style="width: 10%; ">
                                    <asp:Label ID="lbl_Instruction" CssClass="LABEL" Text="Instruction :"
                                        runat="server" meta:resourcekey="lbl_InstructionResource1"></asp:Label>
                                </td>
                                <td colspan="8"  align="left" style="width: 80%">
                            ...
                            <tr id="tr_InstructionRemark" runat="server" >
                                <td class="TD1" style="width: 10%; ">
                                ...
                                <td colspan="8" style="height: 34px;width: 80%" align="left" >
                                    <asp:TextBox ID="txt_InstructionRemark" runat="server" Width="450" CssClass="TEXTBOX" TextMode="MultiLine"
                                        onkeyPress=" return Check_Max_Length_For_Multiline(this,100);" MaxLength="100"></asp:TextBox>                                        
                                </td>
                                <td class="TDMANDATORY" style="width: 1%;"></td>
                            </tr>
                            <tr id="tr_Enclosure" runat="server" >
                                <td class="TD1" style="width: 10%">
                                    <asp:Label ID="lbl_Enclosure" CssClass="LABEL" Text="Enclosure's :" runat="server"
                                        meta:resourcekey="lbl_EnclosureResource1"></asp:Label>
                                </td>
                                <td colspan="8" align="left" style="width: 80%">
                                    <asp:TextBox ID="txt_Enclosure" runat="server" Width="99%" CssClass="TEXTBOX" MaxLength="50"></asp:TextBox>
                                </td>
                                <td class="TDMANDATORY" style="width: 1%"></td>
                            </tr>
                            <tr id="tr_LoadingSuperVisor" runat="server" style="height:1" >
          ...
          <td colspan="5"  style="vertical-align: top;">
            <asp:UpdatePanel ID="upd_tbl_Charges" runat="server" UpdateMode="conditional">
                <contenttemplate>
                    ...
                    <tr>
                        ...
                        <td style="width: 69%">
                            <asp:DropDownList ID="ddl_ServiceTaxPayableBy"  runat="server" CssClass="DROPDOWN" Width="100" ReadOnly="true">
                    ...
                    <tr id="tr_ddl_LengthChargeHead" runat="server">
                        <td style="width: 30%" class="TD1">
                    ...
                    <tr>
                        <td style="width: 60%" class="TD1">
                            <asp:Label ID="lbl_Freight" runat="server" meta:resourcekey="lbl_FreightResource1"
                                CssClass="LABEL" Text="Freight :"></asp:Label>
                        </td>
                        <td style="width: 39%">
                            <asp:TextBox ID="txt_Freight" onkeypress="return Only_Numbers(this,event);" runat="server"
                                CssClass="TEXTBOXNOS"  MaxLength="10" Width="95%" onchange="On_Freight_Change();"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 39%">
                            <asp:TextBox ID="txt_LocalCharge" onkeypress="return Only_Numbers(this,event);" runat="server"
                                CssClass="TEXTBOXNOS" Width="95%" onchange="On_LocalCharge_Change();"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 39%">
                            <asp:TextBox ID="txt_LoadingCharge" onkeypress="return Only_Numbers(this,event);" runat="server"
                                CssClass="TEXTBOXNOS" MaxLength="10" Width="95%" onchange="On_LoadingCharge_Change();"></asp:TextBox>
                    ...
                    <tr> 
                        ...
                        <td style="width: 39%">
                            <asp:TextBox ID="txt_StationaryCharge" onkeypress="return Only_Numbers(this,event);" runat="server"
                                CssClass="TEXTBOXNOS" MaxLength="10" Width="95%" onchange="On_StationaryCharge_Change();"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 39%">
                            <asp:TextBox ID="txt_FOVRiskCharge" onkeypress="return Only_Numbers(this,event);" runat="server"
                                CssClass="TEXTBOXNOS" MaxLength="10" Width="95%" onchange="On_FOVRiskCharge_Change();"></asp:TextBox>
                    ...
                    <tr id="tr_ToPayCharge" runat="server">
                        ...
                        <td style="width: 39%">
                            <asp:TextBox ID="txt_ToPayCharge" onkeypress="return Only_Numbers(this,event);" runat="server"
                                CssClass="TEXTBOXNOS" MaxLength="10" Width="95%" onchange="On_ToPayCharge_Change();"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 39%">
                            <asp:TextBox ID="txt_DDCharge" onkeypress="return Only_Numbers(this,event);" runat="server"
                                CssClass="TEXTBOXNOS" MaxLength="10" Width="95%" onchange="On_DDCharge_Change();"></asp:TextBox>
                            <asp:HiddenField ID="hdn_DDCharge" runat="server"></asp:HiddenField>
                        </td>
                    </tr>
                    <tr id="tr_DACC" runat="server">
                        <td style="width: 60%" class="TD1">
                            <asp:Label ID="lbl_DACCCharge" runat="server" meta:resourcekey="lbl_DACCChargeResource1"
                                CssClass="LABEL" Text="IBA Charge :"></asp:Label>
                        </td>
                        <td style="width: 39%">
                            <asp:TextBox ID="txt_DACCCharge" onkeypress="return Only_Numbers(this,event);" runat="server" 
                                CssClass="TEXTBOXNOS" MaxLength="10" Width="95%" onchange="On_DACCCharge_Change();"></asp:TextBox>
                            <asp:HiddenField ID="hdn_DACCCharge" runat="server"></asp:HiddenField>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 60%" class="TD1">
                            <asp:LinkButton ID="lnk_OtherCharges"  runat="server"
                                meta:resourcekey="lbl_OtherChargeResource1" Text="Other Charges."
                        ...
                        <td style="width: 39%">                        
                            <asp:Label ID="lbl_OtherChargesValue" runat="server" CssClass="LABEL" width="98%" Style="text-align: right"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td style="width: 39%">
                            <asp:TextBox ID="txt_NFormCharge" onkeypress="return Only_Numbers(this,event);" runat="server" 
                                CssClass="TEXTBOXNOS"  MaxLength="10" Width="95%" onchange="On_NFormCharge_Change();"></asp:TextBox>
                            <asp:HiddenField ID="hdn_NFormCharge" runat="server"></asp:HiddenField>
                        </td>
                    </tr>                            
                     <tr id="tr_LengthCharge" runat="server">
                        <td style="width: 60%" class="TD1">
                        ...
                        <td style="width: 39%">
                            <asp:TextBox ID="txt_LengthCharge" onkeypress="return Only_Numbers(this,event);" runat="server"
                                CssClass="TEXTBOXNOS" MaxLength="10" Width="95%" onchange="On_LengthCharge_Change();" ></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 39%">
                            <asp:TextBox ID="txt_UnloadingCharge" onkeypress="return Only_Numbers(this,event);" runat="server"
                                CssClass="TEXTBOXNOS" MaxLength="10" Width="95%" onchange="On_UnloadingCharge_Change();" ></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 39%">
                            <asp:Label Style="text-align: right" ID="lbl_SubTotalValue" width="98%" runat="server" 
                                        CssClass="LABEL" Font-Bold="True"></asp:Label>
                    ...
                    <tr>
                        <td style="width: 60%" class="TD1">
                            <asp:Label ID="lbl_Abatment" runat="server" meta:resourcekey="lbl_AbatmentResource1"
                                CssClass="LABEL" Text="Abatement :"></asp:Label>
                        </td>
                        <td style="width: 39%">
                           <asp:Label   Style="text-align: right" ID="lbl_AbatmentValue" width="98%"  runat="server" 
                                        CssClass="LABEL" Font-Bold="True"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td style="width: 39%">
                            <asp:Label Style="text-align: right" ID="lbl_TaxableAmountValue" width="98%" runat="server" 
                                        CssClass="LABEL" Font-Bold="True"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td style="width: 39%">
                            <asp:Label Style="text-align: right" ID="lbl_ServiceTaxValue" width="98%" runat="server" 
                                        CssClass="LABEL" Font-Bold="True"></asp:Label>
                    ...
                    <tr>
                        <td style="width: 60%" class="TD1">
                            <asp:Label ID="lbl_TotalGCAmount" onkeypress="return Only_Numbers(this,event);" runat="server"
                                meta:resourcekey="lbl_TotalGCAmountResource1" CssClass="LABEL" Text="Total GC Amount :"></asp:Label>
                        </td>
                        <td style="width: 39%">
                                <asp:Label Style="text-align: right" ID="lbl_TotalGCAmountValue" width="98%" runat="server" 
                                        CssClass="LABEL" Font-Bold="True"></asp:Label>                                        
...
<table style="vertical-align: top; width: 100%" class="TABLE">
    <tr id = "tr_PaymentDetails" runat="server" >
        <td class="TD1" width="100%">
            <asp:UpdatePanel ID="upd_tbl_PaymentDetails" runat="server">
                <contenttemplate>
                    ...
                    <tr>
                        ...
                        <td style="width: 7%">
                            <asp:TextBox onblur="Set_Cheque_Details();" ID="txt_ChequeAmount" onkeypress="return Only_Numbers(this,event);" runat="server"
                    ...
                    <tr id= "tr_cheque_Details" runat = "server">
                        ...
                        <td style="width: 7%">
                            <asp:TextBox onblur="On_BankName_Change();" ID="txt_BankName" runat="server"
                                CssClass="TEXTBOX" MaxLength="10" Width="95%"></asp:TextBox>
...
<table class="TABLE" style="width: 100%;">
    ...
    <tr>
        <td align="center">
            <asp:UpdatePanel ID="upd_button" runat="server" UpdateMode="conditional">
                <contenttemplate>
                    ...
                    &nbsp
                    <asp:Button ID="btn_Save_Repeat" runat="server" Text="Save & Repeat" CssClass="BUTTON" 
                    ValidationGroup="Save" OnClick="btn_Save_Repeat_Click" AccessKey="R"/>
...
<table class="TABLE"  id="tbl_Consingor_Consignee_Details"  runat="server">
        ...
        <td>        
         <asp:UpdatePanel ID="upd_tr_Consingor_Consignee_Details" runat="server">
            ...
            <table>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsigneeAddressLine1" runat="server"
                            CssClass="LABEL" Text="Address 1 :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsigneeAddressLine1" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="100" Width="95%" 
                            TextMode="MultiLine" onkeyPress=" return Check_Max_Length_For_Multiline(this,100);" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsigneeAddressLine2" runat="server"
                            CssClass="LABEL" Text="Address 2 :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsigneeAddressLine2" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="100" 
                            Width="95%" TextMode="MultiLine" onkeyPress=" return Check_Max_Length_For_Multiline(this,100);" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsigneeCity" runat="server" CssClass="LABEL" Text="City :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsigneeCity" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="50" Width="95%" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsigneePinCode" runat="server" CssClass="LABEL" Text="PinCode :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsigneePinCode" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="50" Width="95%" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsigneeTelNo" runat="server" CssClass="LABEL" Text="Tel. No :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsigneeTelNo" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="50" Width="95%" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsigneeMobileNo" runat="server" CssClass="LABEL" Text="Mobile No. :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsigneeMobileNo" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="50" Width="95%" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsigneeEmail" runat="server" CssClass="LABEL" Text="Email :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsigneeEmail" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="50" Width="95%" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsigneeCSTNo" runat="server" CssClass="LABEL" Text="CST No. :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsigneeCSTNo" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="50" Width="95%" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsignorAddressLine1" runat="server" CssClass="LABEL" Text="Address 1 :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsignorAddressLine1" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="100" Width="95%" TextMode="MultiLine"
                            onkeyPress=" return Check_Max_Length_For_Multiline(this,100);" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsignorAddressLine2" runat="server" CssClass="LABEL" Text="Address 2 :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsignorAddressLine2" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="100" Width="95%" TextMode="MultiLine"
                            onkeyPress=" return Check_Max_Length_For_Multiline(this,100);" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsignorCity" runat="server" CssClass="LABEL" Text="City :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsignorCity" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="50" Width="95%" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsignorPinCode" runat="server" CssClass="LABEL" Text="PinCode :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsignorPinCode" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="50" Width="95%" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsignorTelNo" runat="server" CssClass="LABEL" Text="Tel. No :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsignorTelNo" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="50" Width="95%" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsignorMobileNo" runat="server" CssClass="LABEL" Text="Mobile No. :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsignorMobileNo" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="50" Width="95%" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsignorEmail" runat="server" CssClass="LABEL" Text="Email :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsignorEmail" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="50" Width="95%" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsignorCSTNo" runat="server" CssClass="LABEL" Text="CST No. :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsignorCSTNo" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="50" Width="95%" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr id="tr_lbl_ConsigneeDDAddressLine1" runat="server">
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsigneeDDAddressLine1" runat="server" CssClass="LABEL" Text="DD Address 1 :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsigneeDDAddressLine1" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="100" Width="95%" TextMode="MultiLine"
                          onkeyPress=" return Check_Max_Length_For_Multiline(this,100);" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr id="tr_lbl_ConsigneeDDAddressLine2" runat="server">
                    <td style="width: 30%" class="TD1">
                        <asp:Label ID="lbl_ConsigneeDDAddressLine2" runat="server" CssClass="LABEL" Text="Address 2 :"></asp:Label>
                    </td>
                    <td style="width: 69%" align="left">
                        <asp:TextBox ID="txt_ConsigneeDDAddressLine2" runat="server" CssClass="TEXTBOXASLABEL" MaxLength="100" Width="95%" TextMode="MultiLine"
                            onkeyPress=" return Check_Max_Length_For_Multiline(this,100);" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>                
            </table>            
...
<table class="TABLE"  id="tbl_InsurenceDetails"  runat="server">
    <tr id="tr_InsurenceDetails" runat="server">
        <td>
            <table>
                <tr>
                    <td style="width: 10%" align="left"></td>
                    <td class="TD1" style="width: 7%;"></td>
                ...
                <tr>
                    ...
                    <td style="width: 15%">
                        <asp:TextBox ID="txt_PolicyAmount" runat="server" Width="95%" CssClass="TEXTBOXNOS" 
                            onkeyPress="return Only_Numbers(this,event);" MaxLength="10"></asp:TextBox>
                    </td>
                    <td class="TD1" style="width: 12%;">
                    ...
                    <td class="TD1" style="width: 15%" colspan="2">
                        <asp:TextBox ID="txt_RiskAmount" runat="server" Width="95%" CssClass="TEXTBOXNOS" 
                            onkeyPress="return Only_Numbers(this,event);" MaxLength="10"></asp:TextBox>
                    </td>
                </tr>
            </table>
...
<table class="TABLE" style="width: 100%;" id="tbl_Hidden_Fields"  runat="server">
   <tr id="tr_Hidden_Fields" runat="server">
        <td class="TD1" style="width: 100%">
            ...
            <asp:HiddenField ID="hdn_Is_POD_Disabled" runat="server" />
            ...
            <asp:HiddenField ID="hdn_RegularClientCaption" runat="server"  />            
        ...
        <td>
            <asp:UpdatePanel ID="upd_Contract_Details" runat="server">
                <contenttemplate>
                    ...
                    <%--<asp:HiddenField runat="server" ID="hdn_Applicable_Standard_FreightRate_For_Calculation"></asp:HiddenField>--%>
                </contenttemplate>
                <triggers>
                    <asp:AsyncPostBackTrigger ControlID="ddl_FromLocation"></asp:AsyncPostBackTrigger>
                    <asp:AsyncPostBackTrigger ControlID="ddl_ToLocation"></asp:AsyncPostBackTrigger>
